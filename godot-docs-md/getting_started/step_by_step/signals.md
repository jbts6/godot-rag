...
To add a button to our game, we will create a new scene which will include both a `Button ` and the `sprite_2d.tscn` scene we created in the `doc_scripting_first_script` lesson.
