...
- Add a `class_name ` at the top of the script, bring up the command palette by pressing `Ctrl + Shift + P`, and enter the class name to run it. The entry will be named according to the class name, with automatic capitalization applied.
