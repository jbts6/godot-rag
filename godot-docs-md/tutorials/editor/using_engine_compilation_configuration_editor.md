...
- Features that are used in `GDExtensions `, unless the language binding allows for defining used classes and the extension makes use of the functionality. See [GH-104129](https://github.com/godotengine/godot/pull/104129) for details.
