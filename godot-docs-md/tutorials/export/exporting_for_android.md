...
All new apps uploaded to Google Play after August 2021 must be an AAB (Android App Bundle) file. To export an AAB file you need to set up `doc_android_gradle_build`.
...
You can optimize the size of your application by compiling an Android export template with only the features you need. See `doc_optimizing_for_size` for more information.
