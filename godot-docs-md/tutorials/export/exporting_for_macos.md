...
[^3]: These options are visible only when signing with rcodesign.

[^4]: These options are visible only when notarizing with Xcode notarytool.

[^5]: These options are visible only when notarizing with Xcode notarytool.

[^6]: These options are visible only when notarizing with Xcode notarytool.
