...
Godot supports a large number of built-in shader functions, conforming roughly to the GLSL ES 3.0 specification.
...
`vec_type (Any of: float, vec2, vec3, vec4)` **radians**(`vec_type (Any of: float, vec2, vec3, vec4)` degrees)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **degrees**(`vec_type (Any of: float, vec2, vec3, vec4)` radians)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **sin**(`vec_type (Any of: float, vec2, vec3, vec4)` angle)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **cos**(`vec_type (Any of: float, vec2, vec3, vec4)` angle)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **tan**(`vec_type (Any of: float, vec2, vec3, vec4)` angle)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **asin**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **acos**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **atan**(`vec_type (Any of: float, vec2, vec3, vec4)` y_over_x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **atan**(`vec_type (Any of: float, vec2, vec3, vec4)` y, `vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **sinh**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **cosh**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **tanh**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **asinh**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **acosh**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **atanh**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **pow**(`vec_type (Any of: float, vec2, vec3, vec4)` x, `vec_type (Any of: float, vec2, vec3, vec4)` y)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **exp**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **exp2**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **log**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **log2**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **sqrt**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **inversesqrt**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **abs**(`vec_type (Any of: float, vec2, vec3, vec4)` x)

`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` **abs**(`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **sign**(`vec_type (Any of: float, vec2, vec3, vec4)` x)

`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` **sign**(`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **floor**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **round**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **roundEven**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **trunc**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **ceil**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **fract**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **mod**(`vec_type (Any of: float, vec2, vec3, vec4)` x, `vec_type (Any of: float, vec2, vec3, vec4)` y)

`vec_type (Any of: float, vec2, vec3, vec4)` **mod**(`vec_type (Any of: float, vec2, vec3, vec4)` x, float y)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **modf**(`vec_type (Any of: float, vec2, vec3, vec4)` x, out `vec_type (Any of: float, vec2, vec3, vec4)` i)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **min**(`vec_type (Any of: float, vec2, vec3, vec4)` a, `vec_type (Any of: float, vec2, vec3, vec4)` b)

`vec_type (Any of: float, vec2, vec3, vec4)` **min**(`vec_type (Any of: float, vec2, vec3, vec4)` a, float b)

`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` **min**(`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` a, `vec_int_type (Any of: int, ivec2, ivec3, ivec4)` b)

`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` **min**(`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` a, int b)

`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` **min**(`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` a, `vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` b)

`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` **min**(`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` a, uint b)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **max**(`vec_type (Any of: float, vec2, vec3, vec4)` a, `vec_type (Any of: float, vec2, vec3, vec4)` b)

`vec_type (Any of: float, vec2, vec3, vec4)` **max**(`vec_type (Any of: float, vec2, vec3, vec4)` a, float b)

`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` **max**(`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` a, `vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` b)

`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` **max**(`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` a, uint b)

`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` **max**(`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` a, `vec_int_type (Any of: int, ivec2, ivec3, ivec4)` b)

`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` **max**(`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` a, int b)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **clamp**(`vec_type (Any of: float, vec2, vec3, vec4)` x, `vec_type (Any of: float, vec2, vec3, vec4)` minVal, `vec_type (Any of: float, vec2, vec3, vec4)` maxVal)

`vec_type (Any of: float, vec2, vec3, vec4)` **clamp**(`vec_type (Any of: float, vec2, vec3, vec4)` x, float minVal, float maxVal)

`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` **clamp**(`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` x, `vec_int_type (Any of: int, ivec2, ivec3, ivec4)` minVal, `vec_int_type (Any of: int, ivec2, ivec3, ivec4)` maxVal)

`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` **clamp**(`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` x, int minVal, int maxVal)

`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` **clamp**(`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` x, `vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` minVal, `vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` maxVal)

`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` **clamp**(`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` x, uint minVal, uint maxVal)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **mix**(`vec_type (Any of: float, vec2, vec3, vec4)` a, `vec_type (Any of: float, vec2, vec3, vec4)` b, `vec_type (Any of: float, vec2, vec3, vec4)` c)

`vec_type (Any of: float, vec2, vec3, vec4)` **mix**(`vec_type (Any of: float, vec2, vec3, vec4)` a, `vec_type (Any of: float, vec2, vec3, vec4)` b, float c)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **mix**(`vec_type (Any of: float, vec2, vec3, vec4)` a, `vec_type (Any of: float, vec2, vec3, vec4)` b, `vec_bool_type (Any of: bool, bvec2, bvec3, bvec4)` c)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **fma**(`vec_type (Any of: float, vec2, vec3, vec4)` a, `vec_type (Any of: float, vec2, vec3, vec4)` b, `vec_type (Any of: float, vec2, vec3, vec4)` c)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **step**(`vec_type (Any of: float, vec2, vec3, vec4)` a, `vec_type (Any of: float, vec2, vec3, vec4)` b)

`vec_type (Any of: float, vec2, vec3, vec4)` **step**(float a, `vec_type (Any of: float, vec2, vec3, vec4)` b)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **smoothstep**(`vec_type (Any of: float, vec2, vec3, vec4)` a, `vec_type (Any of: float, vec2, vec3, vec4)` b, `vec_type (Any of: float, vec2, vec3, vec4)` c)

`vec_type (Any of: float, vec2, vec3, vec4)` **smoothstep**(float a, float b, `vec_type (Any of: float, vec2, vec3, vec4)` c)
...
`vec_bool_type (Any of: bool, bvec2, bvec3, bvec4)` **isnan**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_bool_type (Any of: bool, bvec2, bvec3, bvec4)` **isinf**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` **floatBitsToInt**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` **floatBitsToUint**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **intBitsToFloat**(`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **uintBitsToFloat**(`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` x)
...
float **length**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
float **distance**(`vec_type (Any of: float, vec2, vec3, vec4)` a, `vec_type (Any of: float, vec2, vec3, vec4)` b)
...
float **dot**(`vec_type (Any of: float, vec2, vec3, vec4)` a, `vec_type (Any of: float, vec2, vec3, vec4)` b)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **normalize**(`vec_type (Any of: float, vec2, vec3, vec4)` x)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **faceforward**(`vec_type (Any of: float, vec2, vec3, vec4)` N, `vec_type (Any of: float, vec2, vec3, vec4)` I, `vec_type (Any of: float, vec2, vec3, vec4)` Nref)
...
`mat_type (Any of: mat2, mat3, mat4)` **matrixCompMult**(`mat_type (Any of: mat2, mat3, mat4)` x, `mat_type (Any of: mat2, mat3, mat4)` y)
...
`mat_type (Any of: mat2, mat3, mat4)` **outerProduct**(`vec_type (Any of: float, vec2, vec3, vec4)` column, `vec_type (Any of: float, vec2, vec3, vec4)` row)
...
`mat_type (Any of: mat2, mat3, mat4)` **transpose**(`mat_type (Any of: mat2, mat3, mat4)` m)
...
float **determinant**(`mat_type (Any of: mat2, mat3, mat4)` m)
...
`mat_type (Any of: mat2, mat3, mat4)` **inverse**(`mat_type (Any of: mat2, mat3, mat4)` m)
...
`vec_bool_type (Any of: bool, bvec2, bvec3, bvec4)` **lessThan**(`vec_type (Any of: float, vec2, vec3, vec4)` x, `vec_type (Any of: float, vec2, vec3, vec4)` y)
...
`vec_bool_type (Any of: bool, bvec2, bvec3, bvec4)` **greaterThan**(`vec_type (Any of: float, vec2, vec3, vec4)` x, `vec_type (Any of: float, vec2, vec3, vec4)` y)
...
`vec_bool_type (Any of: bool, bvec2, bvec3, bvec4)` **lessThanEqual**(`vec_type (Any of: float, vec2, vec3, vec4)` x, `vec_type (Any of: float, vec2, vec3, vec4)` y)
...
`vec_bool_type (Any of: bool, bvec2, bvec3, bvec4)` **greaterThanEqual**(`vec_type (Any of: float, vec2, vec3, vec4)` x, `vec_type (Any of: float, vec2, vec3, vec4)` y)
...
`vec_bool_type (Any of: bool, bvec2, bvec3, bvec4)` **equal**(`vec_type (Any of: float, vec2, vec3, vec4)` x, `vec_type (Any of: float, vec2, vec3, vec4)` y)
...
`vec_bool_type (Any of: bool, bvec2, bvec3, bvec4)` **notEqual**(`vec_type (Any of: float, vec2, vec3, vec4)` x, `vec_type (Any of: float, vec2, vec3, vec4)` y)
...
bool **any**(`vec_bool_type (Any of: bool, bvec2, bvec3, bvec4)` x)
...
bool **all**(`vec_bool_type (Any of: bool, bvec2, bvec3, bvec4)` x)
...
`vec_bool_type (Any of: bool, bvec2, bvec3, bvec4)` **not**(`vec_bool_type (Any of: bool, bvec2, bvec3, bvec4)` x)
...
ivec2 **textureSize**(`gsampler2D (Any of: sampler2D, isampler2D, uSampler2D)` s, int lod)

ivec2 **textureSize**(samplerCube s, int lod)

ivec2 **textureSize**(samplerCubeArray s, int lod)

ivec3 **textureSize**(`gsampler2DArray (Any of: sampler2DArray, isampler2DArray, uSampler2DArray)` s, int lod)

ivec3 **textureSize**(`gsampler3D (Any of: sampler3D, isampler3D, uSampler3D)` s, int lod)
...
vec2 **textureQueryLod**(`gsampler2D (Any of: sampler2D, isampler2D, uSampler2D)` s, vec2 p)

vec2 **textureQueryLod**(`gsampler2DArray (Any of: sampler2DArray, isampler2DArray, uSampler2DArray)` s, vec2 p)

vec2 **textureQueryLod**(`gsampler3D (Any of: sampler3D, isampler3D, uSampler3D)` s, vec3 p)
...
int **textureQueryLevels**(`gsampler2D (Any of: sampler2D, isampler2D, uSampler2D)` s)

int **textureQueryLevels**(`gsampler2DArray (Any of: sampler2DArray, isampler2DArray, uSampler2DArray)` s)

int **textureQueryLevels**(`gsampler3D (Any of: sampler3D, isampler3D, uSampler3D)` s)
...
`gvec4_type (Any of: vec4, ivec4, uvec4)` **texture**(`gsampler2D (Any of: sampler2D, isampler2D, uSampler2D)` s, vec2 p \[, float bias\] )

`gvec4_type (Any of: vec4, ivec4, uvec4)` **texture**(`gsampler2DArray (Any of: sampler2DArray, isampler2DArray, uSampler2DArray)` s, vec3 p \[, float bias\] )

`gvec4_type (Any of: vec4, ivec4, uvec4)` **texture**(`gsampler3D (Any of: sampler3D, isampler3D, uSampler3D)` s, vec3 p \[, float bias\] )
...
`gvec4_type (Any of: vec4, ivec4, uvec4)` **textureProj**(`gsampler2D (Any of: sampler2D, isampler2D, uSampler2D)` s, vec3 p \[, float bias\] )

`gvec4_type (Any of: vec4, ivec4, uvec4)` **textureProj**(`gsampler2D (Any of: sampler2D, isampler2D, uSampler2D)` s, vec4 p \[, float bias\] )

`gvec4_type (Any of: vec4, ivec4, uvec4)` **textureProj**(`gsampler3D (Any of: sampler3D, isampler3D, uSampler3D)` s, vec4 p \[, float bias\] )
...
`gvec4_type (Any of: vec4, ivec4, uvec4)` **textureLod**(`gsampler2D (Any of: sampler2D, isampler2D, uSampler2D)` s, vec2 p, float lod)

`gvec4_type (Any of: vec4, ivec4, uvec4)` **textureLod**(`gsampler2DArray (Any of: sampler2DArray, isampler2DArray, uSampler2DArray)` s, vec3 p, float lod)

`gvec4_type (Any of: vec4, ivec4, uvec4)` **textureLod**(`gsampler3D (Any of: sampler3D, isampler3D, uSampler3D)` s, vec3 p, float lod)
...
`gvec4_type (Any of: vec4, ivec4, uvec4)` **textureProjLod**(`gsampler2D (Any of: sampler2D, isampler2D, uSampler2D)` s, vec3 p, float lod)

`gvec4_type (Any of: vec4, ivec4, uvec4)` **textureProjLod**(`gsampler2D (Any of: sampler2D, isampler2D, uSampler2D)` s, vec4 p, float lod)

`gvec4_type (Any of: vec4, ivec4, uvec4)` **textureProjLod**(`gsampler3D (Any of: sampler3D, isampler3D, uSampler3D)` s, vec4 p, float lod)
...
`gvec4_type (Any of: vec4, ivec4, uvec4)` **textureGrad**(`gsampler2D (Any of: sampler2D, isampler2D, uSampler2D)` s, vec2 p, vec2 dPdx, vec2 dPdy)

`gvec4_type (Any of: vec4, ivec4, uvec4)` **textureGrad**(`gsampler2DArray (Any of: sampler2DArray, isampler2DArray, uSampler2DArray)` s, vec3 p, vec2 dPdx, vec2 dPdy)

`gvec4_type (Any of: vec4, ivec4, uvec4)` **textureGrad**(`gsampler3D (Any of: sampler3D, isampler3D, uSampler3D)` s, vec3 p, vec2 dPdx, vec2 dPdy)
...
`gvec4_type (Any of: vec4, ivec4, uvec4)` **textureProjGrad**(`gsampler2D (Any of: sampler2D, isampler2D, uSampler2D)` s, vec3 p, vec2 dPdx, vec2 dPdy)

`gvec4_type (Any of: vec4, ivec4, uvec4)` **textureProjGrad**(`gsampler2D (Any of: sampler2D, isampler2D, uSampler2D)` s, vec4 p, vec2 dPdx, vec2 dPdy)

`gvec4_type (Any of: vec4, ivec4, uvec4)` **textureProjGrad**(`gsampler3D (Any of: sampler3D, isampler3D, uSampler3D)` s, vec4 p, vec3 dPdx, vec3 dPdy)
...
`gvec4_type (Any of: vec4, ivec4, uvec4)` **texelFetch**(`gsampler2D (Any of: sampler2D, isampler2D, uSampler2D)` s, ivec2 p, int lod)

`gvec4_type (Any of: vec4, ivec4, uvec4)` **texelFetch**(`gsampler2DArray (Any of: sampler2DArray, isampler2DArray, uSampler2DArray)` s, ivec3 p, int lod)

`gvec4_type (Any of: vec4, ivec4, uvec4)` **texelFetch**(`gsampler3D (Any of: sampler3D, isampler3D, uSampler3D)` s, ivec3 p, int lod)
...
`gvec4_type (Any of: vec4, ivec4, uvec4)` **textureGather**(`gsampler2D (Any of: sampler2D, isampler2D, uSampler2D)` s, vec2 p \[, int comps\] )

`gvec4_type (Any of: vec4, ivec4, uvec4)` **textureGather**(`gsampler2DArray (Any of: sampler2DArray, isampler2DArray, uSampler2DArray)` s, vec3 p \[, int comps\] )
...
`vec_type (Any of: float, vec2, vec3, vec4)` **dFdx**(`vec_type (Any of: float, vec2, vec3, vec4)` p)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **dFdxCoarse**(`vec_type (Any of: float, vec2, vec3, vec4)` p)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **dFdxFine**(`vec_type (Any of: float, vec2, vec3, vec4)` p)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **dFdy**(`vec_type (Any of: float, vec2, vec3, vec4)` p)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **dFdyCoarse**(`vec_type (Any of: float, vec2, vec3, vec4)` p)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **dFdyFine**(`vec_type (Any of: float, vec2, vec3, vec4)` p)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **fwidth**(`vec_type (Any of: float, vec2, vec3, vec4)` p)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **fwidthCoarse**(`vec_type (Any of: float, vec2, vec3, vec4)` p)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **fwidthFine**(`vec_type (Any of: float, vec2, vec3, vec4)` p)
...
`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` **bitfieldExtract**(`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` value, int offset, int bits)
...
`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` **bitfieldExtract**(`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` value, int offset, int bits)
...
`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` **bitfieldInsert**(`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` base, `vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` insert, int offset, int bits)
...
`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` **bitfieldReverse**(`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` value)

`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` **bitfieldReverse**(`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` value)
...
`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` **bitCount**(`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` value)

`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` **bitCount**(`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` value)
...
`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` **findLSB**(`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` value)

`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` **findLSB**(`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` value)
...
`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` **findMSB**(`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` value)

`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` **findMSB**(`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` value)
...
`void (No return value.)` **imulExtended**(`vec_int_type (Any of: int, ivec2, ivec3, ivec4)` x, `vec_int_type (Any of: int, ivec2, ivec3, ivec4)` y, out `vec_int_type (Any of: int, ivec2, ivec3, ivec4)` msb, out `vec_int_type (Any of: int, ivec2, ivec3, ivec4)` lsb)
...
`void (No return value.)` **umulExtended**(`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` x, `vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` y, out `vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` msb, out `vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` lsb)
...
`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` **uaddCarry**(`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` x, `vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` y, out `vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` carry)
...
`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` **usubBorrow**(`vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` x, `vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` y, out `vec_uint_type (Any of: uint, uvec2, uvec3, uvec4)` borrow)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **ldexp**(`vec_type (Any of: float, vec2, vec3, vec4)` x, out `vec_int_type (Any of: int, ivec2, ivec3, ivec4)` exp)
...
`vec_type (Any of: float, vec2, vec3, vec4)` **frexp**(`vec_type (Any of: float, vec2, vec3, vec4)` x, out `vec_int_type (Any of: int, ivec2, ivec3, ivec4)` exp)
