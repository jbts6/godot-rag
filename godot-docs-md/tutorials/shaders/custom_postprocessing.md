...
<class_CanvasLayer>`, and give it a `ColorRect `. Assign a new `ShaderMaterial ` to the newly created `ColorRect`, and set the `ColorRect`'s anchor preset to Full Rect:
