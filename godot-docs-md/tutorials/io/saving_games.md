...
`Binary serialization` is an alternative approach for storing game state, and you can use it with the functions `get_var` and `store_var` of `class_FileAccess`.
