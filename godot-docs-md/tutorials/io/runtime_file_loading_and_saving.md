...
- `Image.save_exr ` or `Image.save_exr_to_buffer `
...
On the other hand, `FontFile.load_bitmap_font ` supports the [BMFont](https://www.angelcode.com/products/bmfont/) format (`.fnt` or `.font`).
