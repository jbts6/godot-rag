...
Because of this, assets are now transparently imported from within the project folder. See `doc_import_process` for more details on how importing works in Godot.
