...
Use `Godot.Collections.Array` for an untyped `Variant` array. `Godot.Collections.Array` is a type-safe wrapper around `Godot.Collections.Array`.

See also `Array in C# `.

## Dictionary

Use `Godot.Collections.Dictionary` for an untyped `Variant` dictionary. `Godot.Collections.Dictionary` is a type-safe wrapper around `Godot.Collections.Dictionary`.
