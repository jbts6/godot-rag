...
> [!NOTE]
> Accessing `AudioEffectSpectrumAnalyzerInstance ` is necessary to make use of this effect. A demo project using this can be found [here](https://github.com/godotengine/godot-demo-projects/tree/master/audio/spectrum).
