...
`void (No return value.)` **area_add_shape**(area: `RID`, shape: `RID`, transform: `Transform2D` = Transform2D(1, 0, 0, 1, 0, 0), disabled: `bool` = false)
...
`void (No return value.)` **area_attach_canvas_instance_id**(area: `RID`, id: `int`)
...
`void (No return value.)` **area_set_shape_transform**(area: `RID`, shape_idx: `int`, transform: `Transform2D`)
...
`void (No return value.)` **area_set_transform**(area: `RID`, transform: `Transform2D`)
...
`void (No return value.)` **body_add_constant_central_force**(body: `RID`, force: `Vector2`)
...
`void (No return value.)` **body_add_constant_force**(body: `RID`, force: `Vector2`, position: `Vector2` = Vector2(0, 0))
...
`void (No return value.)` **body_add_constant_torque**(body: `RID`, torque: `float`)
...
`void (No return value.)` **body_add_shape**(body: `RID`, shape: `RID`, transform: `Transform2D` = Transform2D(1, 0, 0, 1, 0, 0), disabled: `bool` = false)
...
`void (No return value.)` **body_apply_central_force**(body: `RID`, force: `Vector2`)
...
`void (No return value.)` **body_apply_central_impulse**(body: `RID`, impulse: `Vector2`)
...
`void (No return value.)` **body_apply_force**(body: `RID`, force: `Vector2`, position: `Vector2` = Vector2(0, 0))
...
`void (No return value.)` **body_apply_impulse**(body: `RID`, impulse: `Vector2`, position: `Vector2` = Vector2(0, 0))
...
`void (No return value.)` **body_apply_torque**(body: `RID`, torque: `float`)
...
`void (No return value.)` **body_apply_torque_impulse**(body: `RID`, impulse: `float`)

Applies a rotational impulse to the body. The impulse does not affect position.

An impulse is time-independent! Applying an impulse every frame would result in a framerate-dependent force. For this reason, it should only be used when simulating one-time impacts (use the "\_force" functions otherwise).

`void (No return value.)` **body_attach_canvas_instance_id**(body: `RID`, id: `int`)
...
`void (No return value.)` **body_set_axis_velocity**(body: `RID`, axis_velocity: `Vector2`)
...
`void (No return value.)` **body_set_constant_force**(body: `RID`, force: `Vector2`)

Sets the body's total constant positional force applied during each physics update.

See `body_add_constant_force()` and `body_add_constant_central_force()`.

`void (No return value.)` **body_set_constant_torque**(body: `RID`, torque: `float`)

Sets the body's total constant rotational force applied during each physics update.

See `body_add_constant_torque()`.

`void (No return value.)` **body_set_continuous_collision_detection_mode**(body: `RID`, mode: `CCDMode`)
...
`void (No return value.)` **body_set_shape_as_one_way_collision**(body: `RID`, shape_idx: `int`, enable: `bool`, margin: `float`, direction: `Vector2` = Vector2(0, 1))
...
`void (No return value.)` **body_set_shape_transform**(body: `RID`, shape_idx: `int`, transform: `Transform2D`)
...
`void (No return value.)` **damped_spring_joint_set_param**(joint: `RID`, param: `DampedSpringParam`, value: `float`)
...
`void (No return value.)` **joint_make_damped_spring**(joint: `RID`, anchor_a: `Vector2`, anchor_b: `Vector2`, body_a: `RID`, body_b: `RID` = RID())
...
`void (No return value.)` **joint_make_groove**(joint: `RID`, groove1_a: `Vector2`, groove2_a: `Vector2`, anchor_b: `Vector2`, body_a: `RID` = RID(), body_b: `RID` = RID())

Makes the joint a groove joint.

`void (No return value.)` **joint_make_pin**(joint: `RID`, anchor: `Vector2`, body_a: `RID`, body_b: `RID` = RID())
...
`void (No return value.)` **joint_set_param**(joint: `RID`, param: `JointParam`, value: `float`)
...
`void (No return value.)` **pin_joint_set_flag**(joint: `RID`, flag: `PinJointFlag`, enabled: `bool`)
