...
- `void (No return value.)` **set_trail_section_subdivisions**(value: `int`)
...
- `void (No return value.)` **set_trail_sections**(value: `int`)
...
- `void (No return value.)` **set_visibility_rect**(value: `Rect2`)
...
`void (No return value.)` **emit_particle**(xform: `Transform2D`, velocity: `Vector2`, color: `Color`, custom: `Color`, flags: `int`)
...
`void (No return value.)` **request_particles_process**(process_time: `float`, process_time_residual: `float` = 0)
