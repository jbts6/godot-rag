...
- `void (No return value.)` **set_angular_limit_enabled**(value: `bool`)
...
- `void (No return value.)` **set_angular_limit_lower**(value: `float`)
...
- `void (No return value.)` **set_angular_limit_upper**(value: `float`)
...
- `void (No return value.)` **set_motor_enabled**(value: `bool`)
...
- `void (No return value.)` **set_motor_target_velocity**(value: `float`)
...
- `void (No return value.)` **set_softness**(value: `float`)
- `float` **get_softness**()
