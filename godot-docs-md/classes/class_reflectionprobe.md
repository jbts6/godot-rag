...
- `void (No return value.)` **set_ambient_color**(value: `Color`)
...
- `void (No return value.)` **set_ambient_color_energy**(value: `float`)
...
- `void (No return value.)` **set_ambient_mode**(value: `AmbientMode`)
...
- `void (No return value.)` **set_blend_distance**(value: `float`)
...
- `void (No return value.)` **set_enable_box_projection**(value: `bool`)
...
- `void (No return value.)` **set_enable_shadows**(value: `bool`)
...
- `void (No return value.)` **set_as_interior**(value: `bool`)
...
- `void (No return value.)` **set_reflection_mask**(value: `int`)
...
- `void (No return value.)` **set_update_mode**(value: `UpdateMode`)
