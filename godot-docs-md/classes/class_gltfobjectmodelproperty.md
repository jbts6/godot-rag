...
- `void (No return value.)` **set_gltf_to_godot_expression**(value: `Expression`)
...
- `void (No return value.)` **set_godot_to_gltf_expression**(value: `Expression`)
...
- `void (No return value.)` **set_json_pointers**(value: `Array`\[`PackedStringArray`\])
...
- `void (No return value.)` **set_node_paths**(value: `Array`\[`NodePath`\])
...
- `void (No return value.)` **set_object_model_type**(value: `GLTFObjectModelType`)
...
- `void (No return value.)` **set_variant_type**(value: `Variant.Type`)
...
`void (No return value.)` **append_node_path**(node_path: `NodePath`)
...
`void (No return value.)` **append_path_to_property**(node_path: `NodePath`, prop_name: `StringName`)
...
`void (No return value.)` **set_types**(variant_type: `Variant.Type`, obj_model_type: `GLTFObjectModelType`)
