...
- `void (No return value.)` **set_clear_mode**(value: `ClearMode`)
...
- `void (No return value.)` **set_size_2d_override**(value: `Vector2i`)
...
- `void (No return value.)` **set_size_2d_override_stretch**(value: `bool`)
