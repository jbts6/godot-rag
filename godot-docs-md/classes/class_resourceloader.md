...
`void (No return value.)` **add_resource_format_loader**(format_loader: `ResourceFormatLoader`, at_front: `bool` = false)
...
`void (No return value.)` **remove_resource_format_loader**(format_loader: `ResourceFormatLoader`)

Unregisters the given `ResourceFormatLoader`.

`void (No return value.)` **set_abort_on_missing_resources**(abort: `bool`)
