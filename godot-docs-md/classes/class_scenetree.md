...
- `void (No return value.)` **set_auto_accept_quit**(value: `bool`)
...
- `void (No return value.)` **set_current_scene**(value: `Node`)
...
- `void (No return value.)` **set_debug_collisions_hint**(value: `bool`)
...
- `void (No return value.)` **set_debug_navigation_hint**(value: `bool`)
...
- `void (No return value.)` **set_debug_paths_hint**(value: `bool`)
...
- `void (No return value.)` **set_edited_scene_root**(value: `Node`)
...
- `void (No return value.)` **set_multiplayer_poll_enabled**(value: `bool`)
...
- `void (No return value.)` **set_pause**(value: `bool`)
- `bool` **is_paused**()
...
- `void (No return value.)` **set_physics_interpolation_enabled**(value: `bool`)
...
- `void (No return value.)` **set_quit_on_go_back**(value: `bool`)
...
`void (No return value.)` **call_group**(group: `StringName`, method: `StringName`, ...) `vararg`
...
`void (No return value.)` **call_group_flags**(flags: `int`, group: `StringName`, method: `StringName`, ...) `vararg`
...
`void (No return value.)` **notify_group**(group: `StringName`, notification: `int`)
...
`void (No return value.)` **notify_group_flags**(call_flags: `int`, group: `StringName`, notification: `int`)
...
`void (No return value.)` **queue_delete**(obj: `Object`)
...
`void (No return value.)` **quit**(exit_code: `int` = 0)
...
`void (No return value.)` **set_group**(group: `StringName`, property: `String`, value: `Variant`)
...
`void (No return value.)` **set_group_flags**(call_flags: `int`, group: `StringName`, property: `String`, value: `Variant`)
...
`void (No return value.)` **set_multiplayer**(multiplayer: `MultiplayerAPI`, root_path: `NodePath` = NodePath(""))
...
`void (No return value.)` **unload_current_scene**()
