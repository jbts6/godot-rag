...
`void (No return value.)` **print**(...) `vararg`
...
`void (No return value.)` **print_rich**(...) `vararg`
...
`void (No return value.)` **print_verbose**(...) `vararg`
...
`void (No return value.)` **printerr**(...) `vararg`
...
`void (No return value.)` **printraw**(...) `vararg`
...
`void (No return value.)` **prints**(...) `vararg`
...
`void (No return value.)` **printt**(...) `vararg`
...
`void (No return value.)` **push_error**(...) `vararg`
...
`void (No return value.)` **push_warning**(...) `vararg`
...
`void (No return value.)` **seed**(base: `int`)
