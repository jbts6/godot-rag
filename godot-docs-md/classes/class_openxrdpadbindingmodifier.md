...
- `void (No return value.)` **set_action_set**(value: `OpenXRActionSet`)
...
- `void (No return value.)` **set_center_region**(value: `float`)
...
- `void (No return value.)` **set_input_path**(value: `String`)
...
- `void (No return value.)` **set_is_sticky**(value: `bool`)
- `bool` **get_is_sticky**()
...
- `void (No return value.)` **set_threshold_released**(value: `float`)
...
- `void (No return value.)` **set_wedge_angle**(value: `float`)
