...
- `void (No return value.)` **set_energy**(value: `float`)
- `float` **get_energy**()
...
- `void (No return value.)` **set_item_cull_mask**(value: `int`)
...
- `void (No return value.)` **set_layer_range_max**(value: `int`)
...
- `void (No return value.)` **set_layer_range_min**(value: `int`)
...
- `void (No return value.)` **set_z_range_max**(value: `int`)
- `int` **get_z_range_max**()
...
- `void (No return value.)` **set_z_range_min**(value: `int`)
- `int` **get_z_range_min**()
...
- `void (No return value.)` **set_shadow_enabled**(value: `bool`)
...
- `void (No return value.)` **set_shadow_filter**(value: `ShadowFilter`)
...
- `void (No return value.)` **set_shadow_smooth**(value: `float`)
...
- `void (No return value.)` **set_item_shadow_cull_mask**(value: `int`)
...
`void (No return value.)` **set_height**(height: `float`)
