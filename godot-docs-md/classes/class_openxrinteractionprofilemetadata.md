...
`void (No return value.)` **register_interaction_profile**(display_name: `String`, openxr_path: `String`, openxr_extension_names: `String`)
...
`void (No return value.)` **register_io_path**(interaction_profile: `String`, display_name: `String`, toplevel_path: `String`, openxr_path: `String`, openxr_extension_names: `String`, action_type: `ActionType`)
...
`void (No return value.)` **register_path_rename**(old_name: `String`, new_name: `String`)

Allows for renaming old input/output paths to new paths in order to load and process older action maps.

`void (No return value.)` **register_profile_rename**(old_name: `String`, new_name: `String`)

Allows for renaming old interaction profile paths to new paths in order to load and process older action maps.

`void (No return value.)` **register_top_level_path**(display_name: `String`, openxr_path: `String`, openxr_extension_names: `String`)
