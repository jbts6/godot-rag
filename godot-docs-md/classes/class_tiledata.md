...
- `void (No return value.)` **set_probability**(value: `float`)
...
- `void (No return value.)` **set_terrain**(value: `int`)
- `int` **get_terrain**()
...
- `void (No return value.)` **set_terrain_set**(value: `int`)
- `int` **get_terrain_set**()
...
- `void (No return value.)` **set_texture_origin**(value: `Vector2i`)
...
- `void (No return value.)` **set_transpose**(value: `bool`)
- `bool` **get_transpose**()
...
`void (No return value.)` **add_collision_polygon**(layer_id: `int`)

Adds a collision polygon to the tile on the given TileSet physics layer.

`void (No return value.)` **add_occluder_polygon**(layer_id: `int`)
...
`void (No return value.)` **remove_collision_polygon**(layer_id: `int`, polygon_index: `int`)

Removes the polygon at index `polygon_index` for TileSet physics layer with index `layer_id`.

`void (No return value.)` **remove_occluder_polygon**(layer_id: `int`, polygon_index: `int`)

Removes the polygon at index `polygon_index` for TileSet occlusion layer with index `layer_id`.

`void (No return value.)` **set_collision_polygon_one_way**(layer_id: `int`, polygon_index: `int`, one_way: `bool`)

Enables/disables one-way collisions on the polygon at index `polygon_index` for TileSet physics layer with index `layer_id`.

`void (No return value.)` **set_collision_polygon_one_way_margin**(layer_id: `int`, polygon_index: `int`, one_way_margin: `float`)
...
`void (No return value.)` **set_collision_polygon_points**(layer_id: `int`, polygon_index: `int`, polygon: `PackedVector2Array`)

Sets the points of the polygon at index `polygon_index` for TileSet physics layer with index `layer_id`.

`void (No return value.)` **set_collision_polygons_count**(layer_id: `int`, polygons_count: `int`)

Sets the polygons count for TileSet physics layer with index `layer_id`.

`void (No return value.)` **set_constant_angular_velocity**(layer_id: `int`, velocity: `float`)

Sets the constant angular velocity. This does not rotate the tile. This angular velocity is applied to objects colliding with this tile.

`void (No return value.)` **set_constant_linear_velocity**(layer_id: `int`, velocity: `Vector2`)

Sets the constant linear velocity. This does not move the tile. This linear velocity is applied to objects colliding with this tile. This is useful to create conveyor belts.

`void (No return value.)` **set_custom_data**(layer_name: `String`, value: `Variant`)

Sets the tile's custom data value for the TileSet custom data layer with name `layer_name`.

`void (No return value.)` **set_custom_data_by_layer_id**(layer_id: `int`, value: `Variant`)

Sets the tile's custom data value for the TileSet custom data layer with index `layer_id`.

`void (No return value.)` **set_navigation_polygon**(layer_id: `int`, navigation_polygon: `NavigationPolygon`)

Sets the navigation polygon for the TileSet navigation layer with index `layer_id`.

`void (No return value.)` **set_occluder**(layer_id: `int`, occluder_polygon: `OccluderPolygon2D`)

**Deprecated:** Use `set_occluder_polygon()` instead.

Sets the occluder for the TileSet occlusion layer with index `layer_id`.

`void (No return value.)` **set_occluder_polygon**(layer_id: `int`, polygon_index: `int`, polygon: `OccluderPolygon2D`)

Sets the occluder for polygon with index `polygon_index` in the TileSet occlusion layer with index `layer_id`.

`void (No return value.)` **set_occluder_polygons_count**(layer_id: `int`, polygons_count: `int`)

Sets the occluder polygon count in the TileSet occlusion layer with index `layer_id`.

`void (No return value.)` **set_terrain_peering_bit**(peering_bit: `CellNeighbor`, terrain: `int`)
