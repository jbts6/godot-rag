...
- `void (No return value.)` **set_clip_children_mode**(value: `ClipChildrenMode`)
...
- `void (No return value.)` **set_light_mask**(value: `int`)
- `int` **get_light_mask**()
...
- `void (No return value.)` **set_oversampling_with_scale**(value: `OversamplingWithScale`)
...
- `void (No return value.)` **set_self_modulate**(value: `Color`)
...
- `void (No return value.)` **set_draw_behind_parent**(value: `bool`)
...
- `void (No return value.)` **set_use_parent_material**(value: `bool`)
...
- `void (No return value.)` **set_visibility_layer**(value: `int`)
...
- `void (No return value.)` **set_y_sort_enabled**(value: `bool`)
...
- `void (No return value.)` **set_z_as_relative**(value: `bool`)
- `bool` **is_z_relative**()
...
- `void (No return value.)` **set_z_index**(value: `int`)
- `int` **get_z_index**()
...
`void (No return value.)` **\_draw**() `virtual (This method should typically be overridden by the user to have any effect.)`
...
`void (No return value.)` **draw_animation_slice**(animation_length: `float`, slice_begin: `float`, slice_end: `float`, offset: `float` = 0.0)

Subsequent drawing commands will be ignored unless they fall within the specified animation slice. This is a faster way to implement animations that loop on background rather than redrawing constantly.

`void (No return value.)` **draw_arc**(center: `Vector2`, radius: `float`, start_angle: `float`, end_angle: `float`, point_count: `int`, color: `Color`, width: `float` = -1.0, antialiased: `bool` = false)
...
`void (No return value.)` **draw_char**(font: `Font`, pos: `Vector2`, char: `String`, font_size: `int` = 16, modulate: `Color` = Color(1, 1, 1, 1), oversampling: `float` = 0.0) `const`
...
`void (No return value.)` **draw_char_outline**(font: `Font`, pos: `Vector2`, char: `String`, font_size: `int` = 16, size: `int` = -1, modulate: `Color` = Color(1, 1, 1, 1), oversampling: `float` = 0.0) `const`
...
`void (No return value.)` **draw_circle**(position: `Vector2`, radius: `float`, color: `Color`, filled: `bool` = true, width: `float` = -1.0, antialiased: `bool` = false)
...
`void (No return value.)` **draw_colored_polygon**(points: `PackedVector2Array`, color: `Color`, uvs: `PackedVector2Array` = PackedVector2Array(), texture: `Texture2D` = null)
...
`void (No return value.)` **draw_dashed_line**(from: `Vector2`, to: `Vector2`, color: `Color`, width: `float` = -1.0, dash: `float` = 2.0, aligned: `bool` = true, antialiased: `bool` = false)
...
`void (No return value.)` **draw_ellipse**(position: `Vector2`, major: `float`, minor: `float`, color: `Color`, filled: `bool` = true, width: `float` = -1.0, antialiased: `bool` = false)
...
`void (No return value.)` **draw_ellipse_arc**(center: `Vector2`, major: `float`, minor: `float`, start_angle: `float`, end_angle: `float`, point_count: `int`, color: `Color`, width: `float` = -1.0, antialiased: `bool` = false)
...
`void (No return value.)` **draw_end_animation**()
...
`void (No return value.)` **draw_lcd_texture_rect_region**(texture: `Texture2D`, rect: `Rect2`, src_rect: `Rect2`, modulate: `Color` = Color(1, 1, 1, 1))
...
`void (No return value.)` **draw_line**(from: `Vector2`, to: `Vector2`, color: `Color`, width: `float` = -1.0, antialiased: `bool` = false)
...
`void (No return value.)` **draw_mesh**(mesh: `Mesh`, texture: `Texture2D`, transform: `Transform2D` = Transform2D(1, 0, 0, 1, 0, 0), modulate: `Color` = Color(1, 1, 1, 1))
...
`void (No return value.)` **draw_msdf_texture_rect_region**(texture: `Texture2D`, rect: `Rect2`, src_rect: `Rect2`, modulate: `Color` = Color(1, 1, 1, 1), outline: `float` = 0.0, pixel_range: `float` = 4.0, scale: `float` = 1.0)
...
`void (No return value.)` **draw_multiline**(points: `PackedVector2Array`, color: `Color`, width: `float` = -1.0, antialiased: `bool` = false)
...
`void (No return value.)` **draw_multiline_colors**(points: `PackedVector2Array`, colors: `PackedColorArray`, width: `float` = -1.0, antialiased: `bool` = false)
...
`void (No return value.)` **draw_multiline_string**(font: `Font`, pos: `Vector2`, text: `String`, alignment: `HorizontalAlignment` = 0, width: `float` = -1, font_size: `int` = 16, max_lines: `int` = -1, modulate: `Color` = Color(1, 1, 1, 1), brk_flags: `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`LineBreakFlag`\] = 3, justification_flags: `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`JustificationFlag`\] = 3, direction: `Direction` = 0, orientation: `Orientation` = 0, oversampling: `float` = 0.0) `const`
...
`void (No return value.)` **draw_multiline_string_outline**(font: `Font`, pos: `Vector2`, text: `String`, alignment: `HorizontalAlignment` = 0, width: `float` = -1, font_size: `int` = 16, max_lines: `int` = -1, size: `int` = 1, modulate: `Color` = Color(1, 1, 1, 1), brk_flags: `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`LineBreakFlag`\] = 3, justification_flags: `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`JustificationFlag`\] = 3, direction: `Direction` = 0, orientation: `Orientation` = 0, oversampling: `float` = 0.0) `const`

Breaks `text` to the lines and draws text outline using the specified `font` at the `pos` in local space (top-left corner). The text will have its color multiplied by `modulate`. If `width` is greater than or equal to 0, the text will be clipped if it exceeds the specified width. If `oversampling` is greater than zero, it is used as font oversampling factor, otherwise viewport oversampling settings are used.

`void (No return value.)` **draw_multimesh**(multimesh: `MultiMesh`, texture: `Texture2D`)

Draws a `MultiMesh` in 2D with the provided texture. See `MultiMeshInstance2D` for related documentation.

**Note:** Styleboxes, textures, and meshes stored only inside local variables should **not** be used with this method in GDScript, because the drawing operation doesn't begin immediately once this method is called. In GDScript, when the function with the local variables ends, the local variables get destroyed before the rendering takes place.

`void (No return value.)` **draw_polygon**(points: `PackedVector2Array`, colors: `PackedColorArray`, uvs: `PackedVector2Array` = PackedVector2Array(), texture: `Texture2D` = null)
...
`void (No return value.)` **draw_polyline**(points: `PackedVector2Array`, color: `Color`, width: `float` = -1.0, antialiased: `bool` = false)
...
`void (No return value.)` **draw_polyline_colors**(points: `PackedVector2Array`, colors: `PackedColorArray`, width: `float` = -1.0, antialiased: `bool` = false)
...
`void (No return value.)` **draw_primitive**(points: `PackedVector2Array`, colors: `PackedColorArray`, uvs: `PackedVector2Array`, texture: `Texture2D` = null)
...
`void (No return value.)` **draw_rect**(rect: `Rect2`, color: `Color`, filled: `bool` = true, width: `float` = -1.0, antialiased: `bool` = false)
...
`void (No return value.)` **draw_set_transform**(position: `Vector2`, rotation: `float` = 0.0, scale: `Vector2` = Vector2(1, 1))
...
`void (No return value.)` **draw_set_transform_matrix**(xform: `Transform2D`)

Sets a custom local transform for drawing via matrix. Anything drawn afterwards will be transformed by this.

`void (No return value.)` **draw_string**(font: `Font`, pos: `Vector2`, text: `String`, alignment: `HorizontalAlignment` = 0, width: `float` = -1, font_size: `int` = 16, modulate: `Color` = Color(1, 1, 1, 1), justification_flags: `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`JustificationFlag`\] = 3, direction: `Direction` = 0, orientation: `Orientation` = 0, oversampling: `float` = 0.0) `const`
...
`void (No return value.)` **draw_string_outline**(font: `Font`, pos: `Vector2`, text: `String`, alignment: `HorizontalAlignment` = 0, width: `float` = -1, font_size: `int` = 16, size: `int` = 1, modulate: `Color` = Color(1, 1, 1, 1), justification_flags: `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`JustificationFlag`\] = 3, direction: `Direction` = 0, orientation: `Orientation` = 0, oversampling: `float` = 0.0) `const`

Draws `text` outline using the specified `font` at the `pos` in local space (bottom-left corner using the baseline of the font). The text will have its color multiplied by `modulate`. If `width` is greater than or equal to 0, the text will be clipped if it exceeds the specified width. If `oversampling` is greater than zero, it is used as font oversampling factor, otherwise viewport oversampling settings are used.

`void (No return value.)` **draw_style_box**(style_box: `StyleBox`, rect: `Rect2`)

Draws a styled rectangle. The `rect` is defined in local space.

**Note:** Styleboxes, textures, and meshes stored only inside local variables should **not** be used with this method in GDScript, because the drawing operation doesn't begin immediately once this method is called. In GDScript, when the function with the local variables ends, the local variables get destroyed before the rendering takes place.

`void (No return value.)` **draw_texture**(texture: `Texture2D`, position: `Vector2`, modulate: `Color` = Color(1, 1, 1, 1))

Draws a texture at a given position. The `position` is defined in local space.

**Note:** Styleboxes, textures, and meshes stored only inside local variables should **not** be used with this method in GDScript, because the drawing operation doesn't begin immediately once this method is called. In GDScript, when the function with the local variables ends, the local variables get destroyed before the rendering takes place.

`void (No return value.)` **draw_texture_rect**(texture: `Texture2D`, rect: `Rect2`, tile: `bool`, modulate: `Color` = Color(1, 1, 1, 1), transpose: `bool` = false)
...
`void (No return value.)` **draw_texture_rect_region**(texture: `Texture2D`, rect: `Rect2`, src_rect: `Rect2`, modulate: `Color` = Color(1, 1, 1, 1), transpose: `bool` = false, clip_uv: `bool` = true)
...
`void (No return value.)` **move_to_front**()
...
`void (No return value.)` **queue_redraw**()
...
`void (No return value.)` **set_instance_shader_parameter**(name: `StringName`, value: `Variant`)

Set the value of a shader uniform for this instance only ([per-instance uniform](../tutorials/shaders/shader_reference/shading_language.html#per-instance-uniforms)). See also `ShaderMaterial.set_shader_parameter()` to assign a uniform on all instances using the same `ShaderMaterial`.
...
`void (No return value.)` **set_visibility_layer_bit**(layer: `int`, enabled: `bool`)
