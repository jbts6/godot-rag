...
- `void (No return value.)` **set_autoplay**(value: `String`)
- `String` **get_autoplay**()
...
- `void (No return value.)` **set_frame_progress**(value: `float`)
...
- `void (No return value.)` **set_sprite_frames**(value: `SpriteFrames`)
...
`void (No return value.)` **play**(name: `StringName` = &"", custom_speed: `float` = 1.0, from_end: `bool` = false)
...
`void (No return value.)` **play_backwards**(name: `StringName` = &"")
...
`void (No return value.)` **set_frame_and_progress**(frame: `int`, progress: `float`)
