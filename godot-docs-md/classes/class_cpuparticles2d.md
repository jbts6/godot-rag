...
- `void (No return value.)` **set_direction**(value: `Vector2`)
...
- `void (No return value.)` **set_emission_normals**(value: `PackedVector2Array`)
...
- `void (No return value.)` **set_emission_points**(value: `PackedVector2Array`)
...
- `void (No return value.)` **set_emission_rect_extents**(value: `Vector2`)
