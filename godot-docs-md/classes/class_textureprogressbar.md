...
- `void (No return value.)` **set_nine_patch_stretch**(value: `bool`)
...
- `void (No return value.)` **set_radial_center_offset**(value: `Vector2`)
...
- `void (No return value.)` **set_fill_degrees**(value: `float`)
...
- `void (No return value.)` **set_radial_initial_angle**(value: `float`)
...
- `void (No return value.)` **set_stretch_margin**(margin: `Side`, value: `int`)
...
- `void (No return value.)` **set_over_texture**(value: `Texture2D`)
...
- `void (No return value.)` **set_progress_texture**(value: `Texture2D`)
...
- `void (No return value.)` **set_texture_progress_offset**(value: `Vector2`)
...
- `void (No return value.)` **set_under_texture**(value: `Texture2D`)
...
- `void (No return value.)` **set_tint_over**(value: `Color`)
- `Color` **get_tint_over**()
...
- `void (No return value.)` **set_tint_progress**(value: `Color`)
...
- `void (No return value.)` **set_tint_under**(value: `Color`)
