...
- `void (No return value.)` **set_accessibility_controls_nodes**(value: `Array`\[`NodePath`\])
...
- `void (No return value.)` **set_accessibility_described_by_nodes**(value: `Array`\[`NodePath`\])
...
- `void (No return value.)` **set_accessibility_flow_to_nodes**(value: `Array`\[`NodePath`\])
...
- `void (No return value.)` **set_accessibility_labeled_by_nodes**(value: `Array`\[`NodePath`\])
...
- `void (No return value.)` **set_accessibility_live**(value: `AccessibilityLiveMode`)
...
- `void (No return value.)` **set_clip_contents**(value: `bool`)
...
- `void (No return value.)` **set_custom_maximum_size**(value: `Vector2`)
...
- `void (No return value.)` **set_custom_minimum_size**(value: `Vector2`)
...
- `void (No return value.)` **set_focus_behavior_recursive**(value: `FocusBehaviorRecursive`)
...
- `void (No return value.)` **set_focus_mode**(value: `FocusMode`)
...
- `void (No return value.)` **set_focus_neighbor**(side: `Side`, neighbor: `NodePath`)
...
- `void (No return value.)` **set_focus_next**(value: `NodePath`)
...
- `void (No return value.)` **set_focus_previous**(value: `NodePath`)
...
- `void (No return value.)` **set_h_grow_direction**(value: `GrowDirection`)
...
- `void (No return value.)` **set_v_grow_direction**(value: `GrowDirection`)
...
- `void (No return value.)` **set_layout_direction**(value: `LayoutDirection`)
...
- `void (No return value.)` **set_localize_numeral_system**(value: `bool`)
...
- `void (No return value.)` **set_mouse_behavior_recursive**(value: `MouseBehaviorRecursive`)
...
- `void (No return value.)` **set_default_cursor_shape**(value: `CursorShape`)
...
- `void (No return value.)` **set_mouse_filter**(value: `MouseFilter`)
...
- `void (No return value.)` **set_force_pass_scroll_events**(value: `bool`)
...
- `void (No return value.)` **set_offset**(side: `Side`, offset: `float`)
...
- `void (No return value.)` **set_offset_transform_enabled**(value: `bool`)
...
- `void (No return value.)` **set_offset_transform_pivot**(value: `Vector2`)
...
- `void (No return value.)` **set_offset_transform_pivot_ratio**(value: `Vector2`)
...
- `void (No return value.)` **set_offset_transform_position**(value: `Vector2`)
...
- `void (No return value.)` **set_offset_transform_position_ratio**(value: `Vector2`)
...
- `void (No return value.)` **set_offset_transform_rotation**(value: `float`)
...
- `void (No return value.)` **set_offset_transform_scale**(value: `Vector2`)
...
- `void (No return value.)` **set_offset_transform_visual_only**(value: `bool`)
...
- `void (No return value.)` **set_pivot_offset**(value: `Vector2`)
...
- `void (No return value.)` **set_pivot_offset_ratio**(value: `Vector2`)
...
- `void (No return value.)` **set_propagate_maximum_size**(value: `bool`)
...
- `void (No return value.)` **set_shortcut_context**(value: `Node`)
...
`BitField (This value is an integer composed as a bitmask of the following flags.)`\[`SizeFlags`\] **size_flags_horizontal** = `1`

- `void (No return value.)` **set_h_size_flags**(value: `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`SizeFlags`\])
- `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`SizeFlags`\] **get_h_size_flags**()
...
- `void (No return value.)` **set_stretch_ratio**(value: `float`)
...
`BitField (This value is an integer composed as a bitmask of the following flags.)`\[`SizeFlags`\] **size_flags_vertical** = `1`

- `void (No return value.)` **set_v_size_flags**(value: `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`SizeFlags`\])
- `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`SizeFlags`\] **get_v_size_flags**()
...
- `void (No return value.)` **set_tooltip_auto_translate_mode**(value: `AutoTranslateMode`)
...
- `void (No return value.)` **set_tooltip_text**(value: `String`)
...
- `void (No return value.)` **set_translation_context**(value: `StringName`)
...
`String` **\_accessibility_get_contextual_info**() `virtual (This method should typically be overridden by the user to have any effect.)` `const`

Return the description of the keyboard shortcuts and other contextual help for this control.

`bool` **\_can_drop_data**(at_position: `Vector2`, data: `Variant`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`void (No return value.)` **\_drop_data**(at_position: `Vector2`, data: `Variant`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`String` **\_get_accessibility_container_name**(node: `Node`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`int` **\_get_cursor_shape**(at_position: `Vector2`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`Variant` **\_get_drag_data**(at_position: `Vector2`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`Vector2` **\_get_maximum_size**() `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`String` **\_get_tooltip**(at_position: `Vector2`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`AutoTranslateMode` **\_get_tooltip_auto_translate_mode_at**(at_position: `Vector2`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`void (No return value.)` **\_gui_input**(event: `InputEvent`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`bool` **\_has_point**(point: `Vector2`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`Object` **\_make_custom_tooltip**(for_text: `String`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`Array`\[`Vector3i`\] **\_structured_text_parser**(args: `Array`, text: `String`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`void (No return value.)` **accept_event**()
...
`void (No return value.)` **accessibility_drag**()

Starts drag-and-drop operation without using a mouse.

`void (No return value.)` **accessibility_drop**()
...
`void (No return value.)` **force_drag**(data: `Variant`, preview: `Control`)
...
`void (No return value.)` **grab_click_focus**()
...
`void (No return value.)` **grab_focus**(hide_focus: `bool` = false)
...
`void (No return value.)` **release_focus**()
...
`void (No return value.)` **set_anchor**(side: `Side`, anchor: `float`, keep_offset: `bool` = false, push_opposite_anchor: `bool` = true)
...
`void (No return value.)` **set_anchor_and_offset**(side: `Side`, anchor: `float`, offset: `float`, push_opposite_anchor: `bool` = false)
...
`void (No return value.)` **set_anchors_and_offsets_preset**(preset: `LayoutPreset`, resize_mode: `LayoutPresetMode` = 0, margin: `int` = 0)

Sets both anchor preset and offset preset. See `set_anchors_preset()` and `set_offsets_preset()`.

`void (No return value.)` **set_anchors_preset**(preset: `LayoutPreset`, keep_offsets: `bool` = false)
...
`void (No return value.)` **set_begin**(position: `Vector2`)

Sets `offset_left` and `offset_top` at the same time. Equivalent of changing `position`.

`void (No return value.)` **set_drag_forwarding**(drag_func: `Callable`, can_drop_func: `Callable`, drop_func: `Callable`)
...
`void (No return value.)` **set_drag_preview**(control: `Control`)
...
`void (No return value.)` **set_end**(position: `Vector2`)
...
`void (No return value.)` **set_global_position**(position: `Vector2`, keep_offsets: `bool` = false)
...
`void (No return value.)` **set_offsets_preset**(preset: `LayoutPreset`, resize_mode: `LayoutPresetMode` = 0, margin: `int` = 0)
...
`void (No return value.)` **set_position**(position: `Vector2`, keep_offsets: `bool` = false)

Sets the `position` to given `position`.

If `keep_offsets` is `true`, control's anchors will be updated instead of offsets.

`void (No return value.)` **set_size**(size: `Vector2`, keep_offsets: `bool` = false)

Sets the size (see `size`).

If `keep_offsets` is `true`, control's anchors will be updated instead of offsets.

`void (No return value.)` **update_maximum_size**()
...
`void (No return value.)` **update_minimum_size**()
