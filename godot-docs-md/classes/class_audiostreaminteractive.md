...
- `void (No return value.)` **set_clip_count**(value: `int`)
- `int` **get_clip_count**()
...
- `void (No return value.)` **set_initial_clip**(value: `int`)
...
`void (No return value.)` **add_transition**(from_clip: `int`, to_clip: `int`, from_time: `TransitionFromTime`, to_time: `TransitionToTime`, fade_mode: `FadeMode`, fade_beats: `float`, use_filler_clip: `bool` = false, filler_clip: `int` = -1, hold_previous: `bool` = false)
...
`void (No return value.)` **erase_transition**(from_clip: `int`, to_clip: `int`)
...
`void (No return value.)` **set_clip_auto_advance**(clip_index: `int`, mode: `AutoAdvanceMode`)

Set whether a clip will auto-advance by changing the auto-advance mode.

`void (No return value.)` **set_clip_auto_advance_next_clip**(clip_index: `int`, auto_advance_next_clip: `int`)
...
`void (No return value.)` **set_clip_name**(clip_index: `int`, name: `StringName`)

Set the name of the current clip (for easier identification).

`void (No return value.)` **set_clip_stream**(clip_index: `int`, stream: `AudioStream`)
