...
- `void (No return value.)` **set_delta_interval**(value: `float`)
...
- `void (No return value.)` **set_visibility_public**(value: `bool`)
...
- `void (No return value.)` **set_replication_config**(value: `SceneReplicationConfig`)
...
- `void (No return value.)` **set_replication_interval**(value: `float`)
...
- `void (No return value.)` **set_root_path**(value: `NodePath`)
...
- `void (No return value.)` **set_visibility_update_mode**(value: `VisibilityUpdateMode`)
...
`void (No return value.)` **add_visibility_filter**(filter: `Callable`)
...
`void (No return value.)` **remove_visibility_filter**(filter: `Callable`)

Removes a peer visibility filter from this synchronizer.

`void (No return value.)` **set_visibility_for**(peer: `int`, visible: `bool`)

Sets the visibility of `peer` to `visible`. If `peer` is `0`, the value of `public_visibility` will be updated instead.

`void (No return value.)` **update_visibility**(for_peer: `int` = 0)
