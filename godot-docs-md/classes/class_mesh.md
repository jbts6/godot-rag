...
- `void (No return value.)` **set_lightmap_size_hint**(value: `Vector2i`)
...
`AABB` **\_get_aabb**() `virtual (This method should typically be overridden by the user to have any effect.)` `required (This method is required to be overridden when extending its base class.)` `const`

Virtual method to override the `AABB` for a custom class extending **Mesh**.

`int` **\_get_blend_shape_count**() `virtual (This method should typically be overridden by the user to have any effect.)` `required (This method is required to be overridden when extending its base class.)` `const`

Virtual method to override the number of blend shapes for a custom class extending **Mesh**.

`StringName` **\_get_blend_shape_name**(index: `int`) `virtual (This method should typically be overridden by the user to have any effect.)` `required (This method is required to be overridden when extending its base class.)` `const`

Virtual method to override the retrieval of blend shape names for a custom class extending **Mesh**.

`int` **\_get_surface_count**() `virtual (This method should typically be overridden by the user to have any effect.)` `required (This method is required to be overridden when extending its base class.)` `const`

Virtual method to override the surface count for a custom class extending **Mesh**.

`void (No return value.)` **\_set_blend_shape_name**(index: `int`, name: `StringName`) `virtual (This method should typically be overridden by the user to have any effect.)` `required (This method is required to be overridden when extending its base class.)`

Virtual method to override the names of blend shapes for a custom class extending **Mesh**.

`int` **\_surface_get_array_index_len**(index: `int`) `virtual (This method should typically be overridden by the user to have any effect.)` `required (This method is required to be overridden when extending its base class.)` `const`

Virtual method to override the surface array index length for a custom class extending **Mesh**.

`int` **\_surface_get_array_len**(index: `int`) `virtual (This method should typically be overridden by the user to have any effect.)` `required (This method is required to be overridden when extending its base class.)` `const`

Virtual method to override the surface array length for a custom class extending **Mesh**.

`Array` **\_surface_get_arrays**(index: `int`) `virtual (This method should typically be overridden by the user to have any effect.)` `required (This method is required to be overridden when extending its base class.)` `const`

Virtual method to override the surface arrays for a custom class extending **Mesh**.

`Array`\[`Array`\] **\_surface_get_blend_shape_arrays**(index: `int`) `virtual (This method should typically be overridden by the user to have any effect.)` `required (This method is required to be overridden when extending its base class.)` `const`

Virtual method to override the blend shape arrays for a custom class extending **Mesh**.

`int` **\_surface_get_format**(index: `int`) `virtual (This method should typically be overridden by the user to have any effect.)` `required (This method is required to be overridden when extending its base class.)` `const`

Virtual method to override the surface format for a custom class extending **Mesh**.

`Dictionary` **\_surface_get_lods**(index: `int`) `virtual (This method should typically be overridden by the user to have any effect.)` `required (This method is required to be overridden when extending its base class.)` `const`

Virtual method to override the surface LODs for a custom class extending **Mesh**.

`Material` **\_surface_get_material**(index: `int`) `virtual (This method should typically be overridden by the user to have any effect.)` `required (This method is required to be overridden when extending its base class.)` `const`

Virtual method to override the surface material for a custom class extending **Mesh**.

`int` **\_surface_get_primitive_type**(index: `int`) `virtual (This method should typically be overridden by the user to have any effect.)` `required (This method is required to be overridden when extending its base class.)` `const`

Virtual method to override the surface primitive type for a custom class extending **Mesh**.

`void (No return value.)` **\_surface_set_material**(index: `int`, material: `Material`) `virtual (This method should typically be overridden by the user to have any effect.)` `required (This method is required to be overridden when extending its base class.)`
...
`void (No return value.)` **surface_set_material**(surf_idx: `int`, material: `Material`)
