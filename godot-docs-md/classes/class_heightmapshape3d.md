...
- `void (No return value.)` **set_map_data**(value: `PackedFloat32Array`)
...
- `void (No return value.)` **set_map_depth**(value: `int`)
- `int` **get_map_depth**()
...
- `void (No return value.)` **set_map_width**(value: `int`)
- `int` **get_map_width**()
...
`void (No return value.)` **update_map_data_from_image**(image: `Image`, height_min: `float`, height_max: `float`)
