...
`void (No return value.)` **set_disable_class**(class_name: `StringName`, disable: `bool`)
...
`void (No return value.)` **set_disable_class_editor**(class_name: `StringName`, disable: `bool`)
...
`void (No return value.)` **set_disable_class_property**(class_name: `StringName`, property: `StringName`, disable: `bool`)
...
`void (No return value.)` **set_disable_feature**(feature: `Feature`, disable: `bool`)
