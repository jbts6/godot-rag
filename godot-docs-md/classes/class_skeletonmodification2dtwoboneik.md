...
- `void (No return value.)` **set_flip_bend_direction**(value: `bool`)
...
- `void (No return value.)` **set_target_maximum_distance**(value: `float`)
...
- `void (No return value.)` **set_target_minimum_distance**(value: `float`)
...
`void (No return value.)` **set_joint_one_bone2d_node**(bone2d_node: `NodePath`)

Sets the `Bone2D` node that is being used as the first bone in the TwoBoneIK modification.

`void (No return value.)` **set_joint_one_bone_idx**(bone_idx: `int`)

Sets the index of the `Bone2D` node that is being used as the first bone in the TwoBoneIK modification.

`void (No return value.)` **set_joint_two_bone2d_node**(bone2d_node: `NodePath`)

Sets the `Bone2D` node that is being used as the second bone in the TwoBoneIK modification.

`void (No return value.)` **set_joint_two_bone_idx**(bone_idx: `int`)
