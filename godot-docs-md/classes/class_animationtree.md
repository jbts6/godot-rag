...
- `void (No return value.)` **set_advance_expression_base_node**(value: `NodePath`)
...
- `void (No return value.)` **set_animation_player**(value: `NodePath`)
...
- `void (No return value.)` **set_tree_root**(value: `AnimationRootNode`)
