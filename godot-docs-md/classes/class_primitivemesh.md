...
- `void (No return value.)` **set_add_uv2**(value: `bool`)
- `bool` **get_add_uv2**()
...
- `void (No return value.)` **set_flip_faces**(value: `bool`)
- `bool` **get_flip_faces**()
...
- `void (No return value.)` **set_uv2_padding**(value: `float`)
...
`Array` **\_create_mesh_array**() `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`void (No return value.)` **request_update**()
