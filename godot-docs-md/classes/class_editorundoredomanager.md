...
`void (No return value.)` **add_do_method**(object: `Object`, method: `StringName`, ...) `vararg`
...
`void (No return value.)` **add_undo_method**(object: `Object`, method: `StringName`, ...) `vararg`
...
`void (No return value.)` **clear_history**(id: `int` = -99, increase_version: `bool` = true)
...
`void (No return value.)` **create_action**(name: `String`, merge_mode: `MergeMode` = 0, custom_context: `Object` = null, backward_undo_ops: `bool` = false, mark_unsaved: `bool` = true)
...
`void (No return value.)` **force_fixed_history**()
