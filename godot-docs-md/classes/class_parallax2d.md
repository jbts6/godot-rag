...
- `void (No return value.)` **set_autoscroll**(value: `Vector2`)
...
- `void (No return value.)` **set_ignore_camera_scroll**(value: `bool`)
...
- `void (No return value.)` **set_repeat_size**(value: `Vector2`)
...
- `void (No return value.)` **set_repeat_times**(value: `int`)
...
- `void (No return value.)` **set_screen_offset**(value: `Vector2`)
...
- `void (No return value.)` **set_scroll_scale**(value: `Vector2`)
