...
- `void (No return value.)` **set_distance_fade_shadow**(value: `float`)
...
- `void (No return value.)` **set_bake_mode**(value: `BakeMode`)
...
- `void (No return value.)` **set_negative**(value: `bool`)
- `bool` **is_negative**()
...
- `void (No return value.)` **set_projector**(value: `Texture2D`)
...
- `void (No return value.)` **set_temperature**(value: `float`)
...
- `void (No return value.)` **set_shadow_caster_mask**(value: `int`)
...
- `void (No return value.)` **set_shadow**(value: `bool`)
- `bool` **has_shadow**()
...
- `void (No return value.)` **set_shadow_reverse_cull_face**(value: `bool`)
