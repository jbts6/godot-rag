...
- `void (No return value.)` **set_bake_mask**(value: `int`)
- `int` **get_bake_mask**()
...
- `void (No return value.)` **set_bake_simplification_distance**(value: `float`)
...
- `void (No return value.)` **set_occluder**(value: `Occluder3D`)
...
`void (No return value.)` **set_bake_mask_value**(layer_number: `int`, value: `bool`)
