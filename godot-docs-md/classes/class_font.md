...
- `void (No return value.)` **set_fallbacks**(value: `Array`\[`Font`\])
...
`BitField (This value is an integer composed as a bitmask of the following flags.)`\[`FontStyle`\] **get_font_style**() `const`
...
`Vector2` **get_multiline_string_size**(text: `String`, alignment: `HorizontalAlignment` = 0, width: `float` = -1, font_size: `int` = 16, max_lines: `int` = -1, brk_flags: `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`LineBreakFlag`\] = 3, justification_flags: `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`JustificationFlag`\] = 3, direction: `Direction` = 0, orientation: `Orientation` = 0) `const`
...
`Vector2` **get_string_size**(text: `String`, alignment: `HorizontalAlignment` = 0, width: `float` = -1, font_size: `int` = 16, justification_flags: `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`JustificationFlag`\] = 3, direction: `Direction` = 0, orientation: `Orientation` = 0) `const`
...
`void (No return value.)` **set_cache_capacity**(single_line: `int`, multi_line: `int`)
