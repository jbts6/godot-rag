...
- `void (No return value.)` **set_bake_interval**(value: `float`)
...
- `void (No return value.)` **set_up_vector_enabled**(value: `bool`)
...
`void (No return value.)` **add_point**(position: `Vector3`, in: `Vector3` = Vector3(0, 0, 0), out: `Vector3` = Vector3(0, 0, 0), index: `int` = -1)
...
`void (No return value.)` **remove_point**(idx: `int`)
...
`void (No return value.)` **set_point_in**(idx: `int`, position: `Vector3`)

Sets the position of the control point leading to the vertex `idx`. If the index is out of bounds, the function sends an error to the console. The position is relative to the vertex.

`void (No return value.)` **set_point_out**(idx: `int`, position: `Vector3`)

Sets the position of the control point leading out of the vertex `idx`. If the index is out of bounds, the function sends an error to the console. The position is relative to the vertex.

`void (No return value.)` **set_point_position**(idx: `int`, position: `Vector3`)

Sets the position for the vertex `idx`. If the index is out of bounds, the function sends an error to the console.

`void (No return value.)` **set_point_tilt**(idx: `int`, tilt: `float`)
