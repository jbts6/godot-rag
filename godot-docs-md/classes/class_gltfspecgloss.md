...
- `void (No return value.)` **set_diffuse_factor**(value: `Color`)
...
- `void (No return value.)` **set_diffuse_img**(value: `Image`)
...
- `void (No return value.)` **set_gloss_factor**(value: `float`)
...
- `void (No return value.)` **set_spec_gloss_img**(value: `Image`)
...
- `void (No return value.)` **set_specular_factor**(value: `Color`)
