...
`String` **chr**(code: `int`) `static (This method doesn't need an instance to be called, so it can be called directly using the class name.)`
...
`String` **humanize_size**(size: `int`) `static (This method doesn't need an instance to be called, so it can be called directly using the class name.)`
...
`String` **num**(number: `float`, decimals: `int` = -1) `static (This method doesn't need an instance to be called, so it can be called directly using the class name.)`
...
`String` **num_int64**(number: `int`, base: `int` = 10, capitalize_hex: `bool` = false) `static (This method doesn't need an instance to be called, so it can be called directly using the class name.)`
...
`String` **num_scientific**(number: `float`) `static (This method doesn't need an instance to be called, so it can be called directly using the class name.)`
...
`String` **num_uint64**(number: `int`, base: `int` = 10, capitalize_hex: `bool` = false) `static (This method doesn't need an instance to be called, so it can be called directly using the class name.)`
