...
- `void (No return value.)` **set_fallback_base_scale**(value: `float`)
...
- `void (No return value.)` **set_fallback_font**(value: `Font`)
...
- `void (No return value.)` **set_fallback_font_size**(value: `int`)
...
- `void (No return value.)` **set_fallback_icon**(value: `Texture2D`)
...
- `void (No return value.)` **set_fallback_stylebox**(value: `StyleBox`)
