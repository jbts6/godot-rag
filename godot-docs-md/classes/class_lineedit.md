...
- `void (No return value.)` **set_caret_column**(value: `int`)
...
- `void (No return value.)` **set_caret_force_displayed**(value: `bool`)
...
- `void (No return value.)` **set_clear_button_enabled**(value: `bool`)
...
- `void (No return value.)` **set_expand_to_text_length_enabled**(value: `bool`)
...
- `void (No return value.)` **set_icon_expand_mode**(value: `ExpandMode`)
...
- `void (No return value.)` **set_keep_editing_on_text_submit**(value: `bool`)
...
- `void (No return value.)` **set_max_length**(value: `int`)
- `int` **get_max_length**()
...
- `void (No return value.)` **set_right_icon**(value: `Texture2D`)
...
- `void (No return value.)` **set_right_icon_scale**(value: `float`)
...
- `void (No return value.)` **set_secret**(value: `bool`)
- `bool` **is_secret**()
...
- `void (No return value.)` **set_secret_character**(value: `String`)
...
- `void (No return value.)` **set_select_all_on_focus**(value: `bool`)
...
- `void (No return value.)` **set_virtual_keyboard_type**(value: `VirtualKeyboardType`)
...
`void (No return value.)` **delete_char_at_caret**()

Deletes one character at the caret's current position (equivalent to pressing `Delete`).

`void (No return value.)` **delete_text**(from_column: `int`, to_column: `int`)
...
`void (No return value.)` **edit**(hide_focus: `bool` = false)
...
`void (No return value.)` **insert_text_at_caret**(text: `String`)
...
`void (No return value.)` **select**(from: `int` = 0, to: `int` = -1)
