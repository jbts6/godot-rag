...
`void (No return value.)` **add_property_info**(info: `Dictionary`)
...
`void (No return value.)` **add_shortcut**(path: `String`, shortcut: `Shortcut`)
...
`void (No return value.)` **erase**(property: `String`)
...
`void (No return value.)` **mark_setting_changed**(setting: `String`)
...
`void (No return value.)` **remove_shortcut**(path: `String`)

Removes the shortcut specified by `path`.

`void (No return value.)` **set_builtin_action_override**(name: `String`, actions_list: `Array`\[`InputEvent`\])

Overrides the built-in editor action `name` with the input actions defined in `actions_list`.

`void (No return value.)` **set_favorites**(dirs: `PackedStringArray`)

Sets the list of favorite files and directories for this project.

`void (No return value.)` **set_initial_value**(name: `StringName`, value: `Variant`, update_current: `bool`)
...
`void (No return value.)` **set_project_metadata**(section: `String`, key: `String`, data: `Variant`)
...
`void (No return value.)` **set_recent_dirs**(dirs: `PackedStringArray`)

Sets the list of recently visited folders in the file dialog for this project.

`void (No return value.)` **set_setting**(name: `String`, value: `Variant`)
