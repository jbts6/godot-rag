...
- `void (No return value.)` **set_ground_color**(value: `Color`)
...
- `void (No return value.)` **set_mie_coefficient**(value: `float`)
...
- `void (No return value.)` **set_mie_color**(value: `Color`)
- `Color` **get_mie_color**()
...
- `void (No return value.)` **set_mie_eccentricity**(value: `float`)
...
- `void (No return value.)` **set_night_sky**(value: `Texture2D`)
...
- `void (No return value.)` **set_rayleigh_coefficient**(value: `float`)
...
- `void (No return value.)` **set_rayleigh_color**(value: `Color`)
...
- `void (No return value.)` **set_sun_disk_scale**(value: `float`)
...
- `void (No return value.)` **set_turbidity**(value: `float`)
- `float` **get_turbidity**()
