...
- `void (No return value.)` **set_default_base_scale**(value: `float`)
...
- `void (No return value.)` **set_default_font**(value: `Font`)
...
- `void (No return value.)` **set_default_font_size**(value: `int`)
...
`void (No return value.)` **add_type**(theme_type: `StringName`)
...
`void (No return value.)` **clear_color**(name: `StringName`, theme_type: `StringName`)
...
`void (No return value.)` **clear_constant**(name: `StringName`, theme_type: `StringName`)
...
`void (No return value.)` **clear_font**(name: `StringName`, theme_type: `StringName`)
...
`void (No return value.)` **clear_font_size**(name: `StringName`, theme_type: `StringName`)
...
`void (No return value.)` **clear_icon**(name: `StringName`, theme_type: `StringName`)
...
`void (No return value.)` **clear_stylebox**(name: `StringName`, theme_type: `StringName`)
...
`void (No return value.)` **clear_theme_item**(data_type: `DataType`, name: `StringName`, theme_type: `StringName`)
...
`void (No return value.)` **clear_type_variation**(theme_type: `StringName`)
...
`void (No return value.)` **merge_with**(other: `Theme`)
...
`void (No return value.)` **remove_type**(theme_type: `StringName`)

Removes the theme type, gracefully discarding defined theme items. If the type is a variation, this information is also erased. If the type is a base for type variations, those variations lose their base.

`void (No return value.)` **rename_color**(old_name: `StringName`, name: `StringName`, theme_type: `StringName`)
...
`void (No return value.)` **rename_constant**(old_name: `StringName`, name: `StringName`, theme_type: `StringName`)
...
`void (No return value.)` **rename_font**(old_name: `StringName`, name: `StringName`, theme_type: `StringName`)
...
`void (No return value.)` **rename_font_size**(old_name: `StringName`, name: `StringName`, theme_type: `StringName`)
...
`void (No return value.)` **rename_icon**(old_name: `StringName`, name: `StringName`, theme_type: `StringName`)
...
`void (No return value.)` **rename_stylebox**(old_name: `StringName`, name: `StringName`, theme_type: `StringName`)
...
`void (No return value.)` **rename_theme_item**(data_type: `DataType`, old_name: `StringName`, name: `StringName`, theme_type: `StringName`)
...
`void (No return value.)` **rename_type**(old_theme_type: `StringName`, theme_type: `StringName`)
...
`void (No return value.)` **set_color**(name: `StringName`, theme_type: `StringName`, color: `Color`)

Creates or changes the value of the `Color` property defined by `name` and `theme_type`. Use `clear_color()` to remove the property.

`void (No return value.)` **set_constant**(name: `StringName`, theme_type: `StringName`, constant: `int`)
...
`void (No return value.)` **set_font**(name: `StringName`, theme_type: `StringName`, font: `Font`)

Creates or changes the value of the `Font` property defined by `name` and `theme_type`. Use `clear_font()` to remove the property.

`void (No return value.)` **set_font_size**(name: `StringName`, theme_type: `StringName`, font_size: `int`)
...
`void (No return value.)` **set_icon**(name: `StringName`, theme_type: `StringName`, texture: `Texture2D`)

Creates or changes the value of the icon property defined by `name` and `theme_type`. Use `clear_icon()` to remove the property.

`void (No return value.)` **set_stylebox**(name: `StringName`, theme_type: `StringName`, texture: `StyleBox`)
...
`void (No return value.)` **set_theme_item**(data_type: `DataType`, name: `StringName`, theme_type: `StringName`, value: `Variant`)
...
`void (No return value.)` **set_type_variation**(theme_type: `StringName`, base_type: `StringName`)
