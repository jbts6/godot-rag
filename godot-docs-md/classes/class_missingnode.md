...
- `void (No return value.)` **set_original_class**(value: `String`)
...
- `void (No return value.)` **set_original_scene**(value: `String`)
...
- `void (No return value.)` **set_recording_properties**(value: `bool`)
...
- `void (No return value.)` **set_recording_signals**(value: `bool`)
