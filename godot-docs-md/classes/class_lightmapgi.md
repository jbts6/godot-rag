...
- `void (No return value.)` **set_bounce_indirect_energy**(value: `float`)
...
- `void (No return value.)` **set_bounces**(value: `int`)
- `int` **get_bounces**()
...
- `void (No return value.)` **set_denoiser_range**(value: `int`)
...
- `void (No return value.)` **set_denoiser_strength**(value: `float`)
...
- `void (No return value.)` **set_directional**(value: `bool`)
- `bool` **is_directional**()
...
- `void (No return value.)` **set_environment_custom_color**(value: `Color`)
...
- `void (No return value.)` **set_environment_custom_energy**(value: `float`)
...
- `void (No return value.)` **set_environment_custom_sky**(value: `Sky`)
...
- `void (No return value.)` **set_environment_mode**(value: `EnvironmentMode`)
...
- `void (No return value.)` **set_generate_probes**(value: `GenerateProbes`)
...
- `void (No return value.)` **set_interior**(value: `bool`)
- `bool` **is_interior**()
...
- `void (No return value.)` **set_light_data**(value: `LightmapGIData`)
...
- `void (No return value.)` **set_max_texture_size**(value: `int`)
...
- `void (No return value.)` **set_bake_quality**(value: `BakeQuality`)
...
- `void (No return value.)` **set_shadowmask_mode**(value: `ShadowmaskMode`)
...
- `void (No return value.)` **set_supersampling_enabled**(value: `bool`)
...
- `void (No return value.)` **set_supersampling_factor**(value: `float`)
...
- `void (No return value.)` **set_texel_scale**(value: `float`)
...
- `void (No return value.)` **set_use_denoiser**(value: `bool`)
...
- `void (No return value.)` **set_use_texture_for_bounces**(value: `bool`)
