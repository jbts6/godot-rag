...
- `void (No return value.)` **set_alpha_cut_mode**(value: `AlphaCutMode`)
...
- `void (No return value.)` **set_draw_flag**(flag: `DrawFlags`, enabled: `bool`)
...
- `void (No return value.)` **set_outline_modulate**(value: `Color`)
...
- `void (No return value.)` **set_outline_render_priority**(value: `int`)
...
- `void (No return value.)` **set_pixel_size**(value: `float`)
...
- `void (No return value.)` **set_text_direction**(value: `Direction`)
