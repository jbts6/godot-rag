...
- `void (No return value.)` **set_custom_arrow_round**(value: `bool`)
...
- `void (No return value.)` **set_custom_arrow_step**(value: `float`)
...
- `void (No return value.)` **set_prefix**(value: `String`)
- `String` **get_prefix**()
...
- `void (No return value.)` **set_update_on_text_changed**(value: `bool`)
