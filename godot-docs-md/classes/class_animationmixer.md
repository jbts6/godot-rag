...
- `void (No return value.)` **set_audio_max_polyphony**(value: `int`)
...
- `void (No return value.)` **set_callback_mode_discrete**(value: `AnimationCallbackModeDiscrete`)
...
- `void (No return value.)` **set_callback_mode_method**(value: `AnimationCallbackModeMethod`)
...
- `void (No return value.)` **set_callback_mode_process**(value: `AnimationCallbackModeProcess`)
...
- `void (No return value.)` **set_reset_on_save_enabled**(value: `bool`)
...
- `void (No return value.)` **set_root_motion_local**(value: `bool`)
...
- `void (No return value.)` **set_root_motion_track**(value: `NodePath`)
...
- `void (No return value.)` **set_root_node**(value: `NodePath`)
...
`Variant` **\_post_process_key_value**(animation: `Animation`, track: `int`, value: `Variant`, object_id: `int`, object_sub_idx: `int`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`void (No return value.)` **capture**(name: `StringName`, duration: `float`, trans_type: `TransitionType` = 0, ease_type: `EaseType` = 0)
...
`void (No return value.)` **clear_caches**()
...
`void (No return value.)` **remove_animation_library**(name: `StringName`)

Removes the `AnimationLibrary` associated with the key `name`.

`void (No return value.)` **rename_animation_library**(name: `StringName`, newname: `StringName`)
