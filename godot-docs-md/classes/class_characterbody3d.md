...
- `void (No return value.)` **set_floor_block_on_wall_enabled**(value: `bool`)
...
- `void (No return value.)` **set_floor_constant_speed_enabled**(value: `bool`)
...
- `void (No return value.)` **set_floor_max_angle**(value: `float`)
...
- `void (No return value.)` **set_floor_snap_length**(value: `float`)
...
- `void (No return value.)` **set_floor_stop_on_slope_enabled**(value: `bool`)
...
- `void (No return value.)` **set_max_slides**(value: `int`)
- `int` **get_max_slides**()
...
- `void (No return value.)` **set_motion_mode**(value: `MotionMode`)
...
- `void (No return value.)` **set_platform_floor_layers**(value: `int`)
...
- `void (No return value.)` **set_platform_on_leave**(value: `PlatformOnLeave`)
...
- `void (No return value.)` **set_platform_wall_layers**(value: `int`)
...
- `void (No return value.)` **set_safe_margin**(value: `float`)
...
- `void (No return value.)` **set_slide_on_ceiling_enabled**(value: `bool`)
...
- `void (No return value.)` **set_up_direction**(value: `Vector3`)
...
- `void (No return value.)` **set_wall_min_slide_angle**(value: `float`)
...
`void (No return value.)` **apply_floor_snap**()
