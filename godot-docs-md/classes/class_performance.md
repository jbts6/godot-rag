...
`void (No return value.)` **add_custom_monitor**(id: `StringName`, callable: `Callable`, arguments: `Array` = \[\], type: `MonitorType` = 0)
...
`void (No return value.)` **remove_custom_monitor**(id: `StringName`)
