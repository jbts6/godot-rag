...
- `void (No return value.)` **set_prefer_global_menu**(value: `bool`)
...
- `void (No return value.)` **set_start_index**(value: `int`)
- `int` **get_start_index**()
...
`void (No return value.)` **set_menu_disabled**(menu: `int`, disabled: `bool`)

If `true`, menu item is disabled.

`void (No return value.)` **set_menu_hidden**(menu: `int`, hidden: `bool`)

If `true`, menu item is hidden.

`void (No return value.)` **set_menu_title**(menu: `int`, title: `String`)

Sets menu item title.

`void (No return value.)` **set_menu_tooltip**(menu: `int`, tooltip: `String`)
