...
- `void (No return value.)` **set_anchor_detection_is_enabled**(value: `bool`)
...
- `void (No return value.)` **set_primary**(value: `bool`)
- `bool` **is_primary**()
...
`void (No return value.)` **stop_passthrough**()
...
`void (No return value.)` **trigger_haptic_pulse**(action_name: `String`, tracker_name: `StringName`, frequency: `float`, amplitude: `float`, duration_sec: `float`, delay_sec: `float`)
