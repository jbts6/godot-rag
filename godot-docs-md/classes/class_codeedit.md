...
- `void (No return value.)` **set_auto_brace_completion_enabled**(value: `bool`)
...
- `void (No return value.)` **set_highlight_matching_braces_enabled**(value: `bool`)
...
- `void (No return value.)` **set_auto_brace_completion_pairs**(value: `Dictionary`)
...
- `void (No return value.)` **set_code_completion_enabled**(value: `bool`)
...
- `void (No return value.)` **set_code_completion_prefixes**(value: `Array`\[`String`\])
...
- `void (No return value.)` **set_comment_delimiters**(value: `Array`\[`String`\])
...
- `void (No return value.)` **set_string_delimiters**(value: `Array`\[`String`\])
...
- `void (No return value.)` **set_draw_bookmarks_gutter**(value: `bool`)
...
- `void (No return value.)` **set_draw_breakpoints_gutter**(value: `bool`)
...
- `void (No return value.)` **set_draw_executing_lines_gutter**(value: `bool`)
...
- `void (No return value.)` **set_draw_fold_gutter**(value: `bool`)
...
- `void (No return value.)` **set_draw_line_numbers**(value: `bool`)
...
- `void (No return value.)` **set_line_numbers_min_digits**(value: `int`)
...
- `void (No return value.)` **set_line_numbers_zero_padded**(value: `bool`)
...
- `void (No return value.)` **set_auto_indent_enabled**(value: `bool`)
...
- `void (No return value.)` **set_auto_indent_prefixes**(value: `Array`\[`String`\])
...
- `void (No return value.)` **set_indent_size**(value: `int`)
- `int` **get_indent_size**()
...
- `void (No return value.)` **set_indent_using_spaces**(value: `bool`)
...
- `void (No return value.)` **set_line_folding_enabled**(value: `bool`)
...
- `void (No return value.)` **set_line_length_guidelines**(value: `Array`\[`int`\])
...
- `void (No return value.)` **set_symbol_lookup_on_click_enabled**(value: `bool`)
...
- `void (No return value.)` **set_symbol_tooltip_on_hover_enabled**(value: `bool`)
...
`void (No return value.)` **\_confirm_code_completion**(replace: `bool`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`Array`\[`Dictionary`\] **\_filter_code_completion_candidates**(candidates: `Array`\[`Dictionary`\]) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`void (No return value.)` **\_request_code_completion**(force: `bool`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`void (No return value.)` **add_auto_brace_completion_pair**(start_key: `String`, end_key: `String`)

Adds a brace pair.

Both the start and end keys must be symbols. Only the start key has to be unique.

`void (No return value.)` **add_code_completion_option**(type: `CodeCompletionKind`, display_text: `String`, insert_text: `String`, text_color: `Color` = Color(1, 1, 1, 1), icon: `Resource` = null, value: `Variant` = null, location: `int` = 1024)
...
`void (No return value.)` **add_comment_delimiter**(start_key: `String`, end_key: `String`, line_only: `bool` = false)
...
`void (No return value.)` **add_string_delimiter**(start_key: `String`, end_key: `String`, line_only: `bool` = false)
...
`void (No return value.)` **cancel_code_completion**()

Cancels the autocomplete menu.

`void (No return value.)` **clear_bookmarked_lines**()

Clears all bookmarked lines.

`void (No return value.)` **clear_breakpointed_lines**()

Clears all breakpointed lines.

`void (No return value.)` **clear_comment_delimiters**()

Removes all comment delimiters.

`void (No return value.)` **clear_executing_lines**()

Clears all executed lines.

`void (No return value.)` **clear_string_delimiters**()

Removes all string delimiters.

`void (No return value.)` **confirm_code_completion**(replace: `bool` = false)

Inserts the selected entry into the text. If `replace` is `true`, any existing text is replaced rather than merged.

`void (No return value.)` **convert_indent**(from_line: `int` = -1, to_line: `int` = -1)

Converts the indents of lines between `from_line` and `to_line` to tabs or spaces as set by `indent_use_spaces`.

Values of `-1` convert the entire text.

`void (No return value.)` **create_code_region**()
...
`void (No return value.)` **delete_lines**()

Deletes all lines that are selected or have a caret on them.

`void (No return value.)` **do_indent**()
...
`void (No return value.)` **duplicate_lines**()

Duplicates all lines currently selected with any caret. Duplicates the entire line beneath the current one no matter where the caret is within the line.

`void (No return value.)` **duplicate_selection**()

Duplicates all selected text and duplicates all lines with a caret on them.

`void (No return value.)` **fold_all_lines**()

Folds all lines that are possible to be folded (see `can_fold_line()`).

`void (No return value.)` **fold_line**(line: `int`)
...
`void (No return value.)` **indent_lines**()
...
`void (No return value.)` **join_lines**(line_ending: `String` = " ")
...
`void (No return value.)` **move_lines_down**()

Moves all lines down that are selected or have a caret on them.

`void (No return value.)` **move_lines_up**()

Moves all lines up that are selected or have a caret on them.

`void (No return value.)` **remove_comment_delimiter**(start_key: `String`)

Removes the comment delimiter with `start_key`.

`void (No return value.)` **remove_string_delimiter**(start_key: `String`)

Removes the string delimiter with `start_key`.

`void (No return value.)` **request_code_completion**(force: `bool` = false)
...
`void (No return value.)` **set_code_completion_selected_index**(index: `int`)

Sets the current selected completion option.

`void (No return value.)` **set_code_hint**(code_hint: `String`)

Sets the code hint text. Pass an empty string to clear.

`void (No return value.)` **set_code_hint_draw_below**(draw_below: `bool`)
...
`void (No return value.)` **set_code_region_tags**(start: `String` = "region", end: `String` = "endregion")

Sets the code region start and end tags (without comment delimiter).

`void (No return value.)` **set_line_as_bookmarked**(line: `int`, bookmarked: `bool`)
...
`void (No return value.)` **set_line_as_breakpoint**(line: `int`, breakpointed: `bool`)
...
`void (No return value.)` **set_line_as_executing**(line: `int`, executing: `bool`)
...
`void (No return value.)` **set_symbol_lookup_word_as_valid**(valid: `bool`)

Sets the symbol emitted by `symbol_validate` as a valid lookup.

`void (No return value.)` **toggle_foldable_line**(line: `int`)

Toggle the folding of the code block at the given line.

`void (No return value.)` **toggle_foldable_lines_at_carets**()

Toggle the folding of the code block on all lines with a caret on them.

`void (No return value.)` **unfold_all_lines**()

Unfolds all lines that are folded.

`void (No return value.)` **unfold_line**(line: `int`)

Unfolds the given line if it is folded or if it is hidden under a folded line.

`void (No return value.)` **unindent_lines**()
...
`void (No return value.)` **update_code_completion_options**(force: `bool`)
