...
- `void (No return value.)` **set_bidirectional**(value: `bool`)
...
- `void (No return value.)` **set_end_position**(value: `Vector2`)
...
- `void (No return value.)` **set_enter_cost**(value: `float`)
...
- `void (No return value.)` **set_travel_cost**(value: `float`)
...
`void (No return value.)` **set_global_end_position**(position: `Vector2`)

Sets the `end_position` that is relative to the link from a global `position`.

`void (No return value.)` **set_global_start_position**(position: `Vector2`)
