...
- `void (No return value.)` **set_display_to_lens**(value: `float`)
...
- `void (No return value.)` **set_display_width**(value: `float`)
...
- `void (No return value.)` **set_eye_height**(value: `float`)
...
- `void (No return value.)` **set_iod**(value: `float`)
- `float` **get_iod**()
...
- `void (No return value.)` **set_k1**(value: `float`)
- `float` **get_k1**()
...
- `void (No return value.)` **set_k2**(value: `float`)
- `float` **get_k2**()
...
- `void (No return value.)` **set_offset_rect**(value: `Rect2`)
...
- `void (No return value.)` **set_oversample**(value: `float`)
