...
- `void (No return value.)` **set_joints**(value: `PackedInt32Array`)
...
- `void (No return value.)` **set_roots**(value: `PackedInt32Array`)
...
`void (No return value.)` **set_godot_bone_node**(godot_bone_node: `Dictionary`)
