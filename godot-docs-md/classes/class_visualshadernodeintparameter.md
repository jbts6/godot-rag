...
- `void (No return value.)` **set_enum_names**(value: `PackedStringArray`)
...
- `void (No return value.)` **set_hint**(value: `Hint`)
- `Hint` **get_hint**()
...
- `void (No return value.)` **set_max**(value: `int`)
- `int` **get_max**()
...
- `void (No return value.)` **set_min**(value: `int`)
- `int` **get_min**()
...
- `void (No return value.)` **set_step**(value: `int`)
- `int` **get_step**()
