...
- `void (No return value.)` **set_light_texture**(value: `TextureLayered`)
...
- `void (No return value.)` **set_lightmap_textures**(value: `Array`\[`TextureLayered`\])
...
- `void (No return value.)` **set_shadowmask_textures**(value: `Array`\[`TextureLayered`\])
...
`void (No return value.)` **add_user**(path: `NodePath`, uv_scale: `Rect2`, slice_index: `int`, sub_instance: `int`)

Adds an object that is considered baked within this **LightmapGIData**.

`void (No return value.)` **clear_users**()
...
`void (No return value.)` **set_uses_spherical_harmonics**(uses_spherical_harmonics: `bool`)
