...
- `void (No return value.)` **set_atlas**(value: `Texture2D`)
- `Texture2D` **get_atlas**()
...
- `void (No return value.)` **set_filter_clip**(value: `bool`)
...
- `void (No return value.)` **set_margin**(value: `Rect2`)
- `Rect2` **get_margin**()
...
- `void (No return value.)` **set_region**(value: `Rect2`)
- `Rect2` **get_region**()
