...
- `void (No return value.)` **set_backspace_deletes_composite_character_enabled**(value: `bool`)
...
- `void (No return value.)` **set_caret_blink_enabled**(value: `bool`)
...
- `void (No return value.)` **set_caret_blink_interval**(value: `float`)
...
- `void (No return value.)` **set_draw_caret_when_editable_disabled**(value: `bool`)
...
- `void (No return value.)` **set_caret_mid_grapheme_enabled**(value: `bool`)
...
- `void (No return value.)` **set_move_caret_on_right_click_enabled**(value: `bool`)
...
- `void (No return value.)` **set_multiple_carets_enabled**(value: `bool`)
...
- `void (No return value.)` **set_caret_type**(value: `CaretType`)
...
- `void (No return value.)` **set_context_menu_enabled**(value: `bool`)
...
- `void (No return value.)` **set_custom_word_separators**(value: `String`)
...
- `void (No return value.)` **set_deselect_on_focus_loss_enabled**(value: `bool`)
...
- `void (No return value.)` **set_drag_and_drop_selection_enabled**(value: `bool`)
...
- `void (No return value.)` **set_draw_control_chars**(value: `bool`)
...
- `void (No return value.)` **set_draw_spaces**(value: `bool`)
...
- `void (No return value.)` **set_draw_tabs**(value: `bool`)
...
- `void (No return value.)` **set_emoji_menu_enabled**(value: `bool`)
...
- `void (No return value.)` **set_empty_selection_clipboard_enabled**(value: `bool`)
...
- `void (No return value.)` **set_highlight_all_occurrences**(value: `bool`)
...
- `void (No return value.)` **set_highlight_current_line**(value: `bool`)
...
- `void (No return value.)` **set_indent_wrapped_lines**(value: `bool`)
...
- `void (No return value.)` **set_middle_mouse_paste_enabled**(value: `bool`)
...
- `void (No return value.)` **set_draw_minimap**(value: `bool`)
...
- `void (No return value.)` **set_minimap_width**(value: `int`)
...
- `void (No return value.)` **set_placeholder**(value: `String`)
...
- `void (No return value.)` **set_fit_content_height_enabled**(value: `bool`)
...
- `void (No return value.)` **set_fit_content_width_enabled**(value: `bool`)
...
- `void (No return value.)` **set_scroll_past_end_of_file_enabled**(value: `bool`)
...
- `void (No return value.)` **set_smooth_scroll_enabled**(value: `bool`)
...
- `void (No return value.)` **set_v_scroll_speed**(value: `float`)
...
- `void (No return value.)` **set_v_scroll**(value: `float`)
- `float` **get_v_scroll**()
...
- `void (No return value.)` **set_selecting_enabled**(value: `bool`)
...
- `void (No return value.)` **set_shortcut_keys_enabled**(value: `bool`)
...
- `void (No return value.)` **set_syntax_highlighter**(value: `SyntaxHighlighter`)
...
- `void (No return value.)` **set_tab_input_mode**(value: `bool`)
...
- `void (No return value.)` **set_use_custom_word_separators**(value: `bool`)
...
- `void (No return value.)` **set_use_default_word_separators**(value: `bool`)
...
- `void (No return value.)` **set_virtual_keyboard_enabled**(value: `bool`)
...
- `void (No return value.)` **set_virtual_keyboard_show_on_focus**(value: `bool`)
...
- `void (No return value.)` **set_line_wrapping_mode**(value: `LineWrappingMode`)
...
`void (No return value.)` **\_backspace**(caret_index: `int`) `virtual (This method should typically be overridden by the user to have any effect.)`

Override this method to define what happens when the user presses the backspace key.

`void (No return value.)` **\_copy**(caret_index: `int`) `virtual (This method should typically be overridden by the user to have any effect.)`

Override this method to define what happens when the user performs a copy operation.

`void (No return value.)` **\_cut**(caret_index: `int`) `virtual (This method should typically be overridden by the user to have any effect.)`

Override this method to define what happens when the user performs a cut operation.

`void (No return value.)` **\_handle_unicode_input**(unicode_char: `int`, caret_index: `int`) `virtual (This method should typically be overridden by the user to have any effect.)`

Override this method to define what happens when the user types in the provided key `unicode_char`.

`void (No return value.)` **\_paste**(caret_index: `int`) `virtual (This method should typically be overridden by the user to have any effect.)`

Override this method to define what happens when the user performs a paste operation.

`void (No return value.)` **\_paste_primary_clipboard**(caret_index: `int`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`void (No return value.)` **add_caret_at_carets**(below: `bool`)
...
`void (No return value.)` **add_gutter**(at: `int` = -1)
...
`void (No return value.)` **add_selection_for_next_occurrence**()

Adds a selection and a caret for the next occurrence of the current selection. If there is no active selection, selects word under caret.

`void (No return value.)` **adjust_carets_after_edit**(caret: `int`, from_line: `int`, from_col: `int`, to_line: `int`, to_col: `int`)

**Deprecated:** No longer necessary since methods now adjust carets themselves.

This method does nothing.

`void (No return value.)` **adjust_viewport_to_caret**(caret_index: `int` = 0)

Adjust the viewport so the caret is visible.

`void (No return value.)` **apply_ime**()
...
`void (No return value.)` **cancel_ime**()
...
`void (No return value.)` **center_viewport_to_caret**(caret_index: `int` = 0)
...
`void (No return value.)` **clear_undo_history**()

Clears the undo history.

`void (No return value.)` **collapse_carets**(from_line: `int`, from_column: `int`, to_line: `int`, to_column: `int`, inclusive: `bool` = false)
...
`void (No return value.)` **copy**(caret_index: `int` = -1)

Copies the current text selection. Can be overridden with `_copy()`.

`void (No return value.)` **cut**(caret_index: `int` = -1)

Cut's the current selection. Can be overridden with `_cut()`.

`void (No return value.)` **delete_selection**(caret_index: `int` = -1)

Deletes the selected text.

`void (No return value.)` **deselect**(caret_index: `int` = -1)

Deselects the current selection.

`void (No return value.)` **end_action**()

Marks the end of steps in the current action started with `start_action()`.

`void (No return value.)` **end_complex_operation**()
...
`void (No return value.)` **end_multicaret_edit**()
...
`void (No return value.)` **insert_line_at**(line: `int`, text: `String`)

Inserts a new line with `text` at `line`.

`void (No return value.)` **insert_text**(text: `String`, line: `int`, column: `int`, before_selection_begin: `bool` = true, before_selection_end: `bool` = false)
...
`void (No return value.)` **insert_text_at_caret**(text: `String`, caret_index: `int` = -1)
...
`void (No return value.)` **menu_option**(option: `int`)

Executes a given action as defined in the `MenuItems` enum.

`void (No return value.)` **merge_gutters**(from_line: `int`, to_line: `int`)

Merge the gutters from `from_line` into `to_line`. Only overwritable gutters will be copied. See `set_gutter_overwritable()`.

`void (No return value.)` **merge_overlapping_carets**()
...
`void (No return value.)` **paste**(caret_index: `int` = -1)

Paste at the current location. Can be overridden with `_paste()`.

`void (No return value.)` **paste_primary_clipboard**(caret_index: `int` = -1)

Pastes the primary clipboard.

`void (No return value.)` **redo**()

Perform redo operation.

`void (No return value.)` **remove_caret**(caret: `int`)

Removes the given caret index.

**Note:** This can result in adjustment of all other caret indices.

`void (No return value.)` **remove_gutter**(gutter: `int`)

Removes the gutter at the given index.

`void (No return value.)` **remove_line_at**(line: `int`, move_carets_down: `bool` = true)
...
`void (No return value.)` **remove_secondary_carets**()

Removes all additional carets.

`void (No return value.)` **remove_text**(from_line: `int`, from_column: `int`, to_line: `int`, to_column: `int`)
...
`void (No return value.)` **select**(origin_line: `int`, origin_column: `int`, caret_line: `int`, caret_column: `int`, caret_index: `int` = 0)
...
`void (No return value.)` **select_all**()

Select all the text.

If `selecting_enabled` is `false`, no selection will occur.

`void (No return value.)` **select_word_under_caret**(caret_index: `int` = -1)

Selects the word under the caret.

`void (No return value.)` **set_caret_column**(column: `int`, adjust_viewport: `bool` = true, caret_index: `int` = 0)
...
`void (No return value.)` **set_caret_line**(line: `int`, adjust_viewport: `bool` = true, can_be_hidden: `bool` = true, wrap_index: `int` = 0, caret_index: `int` = 0)
...
`void (No return value.)` **set_gutter_clickable**(gutter: `int`, clickable: `bool`)
...
`void (No return value.)` **set_gutter_custom_draw**(column: `int`, draw_callback: `Callable`)
...
`void (No return value.)` **set_gutter_draw**(gutter: `int`, draw: `bool`)
...
`void (No return value.)` **set_gutter_name**(gutter: `int`, name: `String`)

Sets the name of the gutter at the given index.

`void (No return value.)` **set_gutter_overwritable**(gutter: `int`, overwritable: `bool`)
...
`void (No return value.)` **set_gutter_type**(gutter: `int`, type: `GutterType`)

Sets the type of gutter at the given index. Gutters can contain icons, text, or custom visuals.

`void (No return value.)` **set_gutter_width**(gutter: `int`, width: `int`)

Set the width of the gutter at the given index.

`void (No return value.)` **set_line**(line: `int`, new_text: `String`)

Sets the text for a specific `line`.

Carets on the line will attempt to keep their visual x position.

`void (No return value.)` **set_line_as_center_visible**(line: `int`, wrap_index: `int` = 0)

Positions the `wrap_index` of `line` at the center of the viewport.

`void (No return value.)` **set_line_as_first_visible**(line: `int`, wrap_index: `int` = 0)

Positions the `wrap_index` of `line` at the top of the viewport.

`void (No return value.)` **set_line_as_last_visible**(line: `int`, wrap_index: `int` = 0)

Positions the `wrap_index` of `line` at the bottom of the viewport.

`void (No return value.)` **set_line_background_color**(line: `int`, color: `Color`)
...
`void (No return value.)` **set_line_gutter_clickable**(line: `int`, gutter: `int`, clickable: `bool`)
...
`void (No return value.)` **set_line_gutter_icon**(line: `int`, gutter: `int`, icon: `Texture2D`)

Sets the icon for `gutter` on `line` to `icon`. This only works when the gutter type is `GUTTER_TYPE_ICON` (see `set_gutter_type()`).

`void (No return value.)` **set_line_gutter_item_color**(line: `int`, gutter: `int`, color: `Color`)

Sets the color for `gutter` on `line` to `color`.

`void (No return value.)` **set_line_gutter_metadata**(line: `int`, gutter: `int`, metadata: `Variant`)

Sets the metadata for `gutter` on `line` to `metadata`.

`void (No return value.)` **set_line_gutter_text**(line: `int`, gutter: `int`, text: `String`)

Sets the text for `gutter` on `line` to `text`. This only works when the gutter type is `GUTTER_TYPE_STRING` (see `set_gutter_type()`).

`void (No return value.)` **set_overtype_mode_enabled**(enabled: `bool`)
...
`void (No return value.)` **set_search_flags**(flags: `int`)
...
`void (No return value.)` **set_search_text**(search_text: `String`)

Sets the search text. See `set_search_flags()`.

`void (No return value.)` **set_selection_mode**(mode: `SelectionMode`)

Sets the current selection mode.

`void (No return value.)` **set_selection_origin_column**(column: `int`, caret_index: `int` = 0)
...
`void (No return value.)` **set_selection_origin_line**(line: `int`, can_be_hidden: `bool` = true, wrap_index: `int` = -1, caret_index: `int` = 0)
...
`void (No return value.)` **set_tab_size**(size: `int`)

Sets the tab size for the **TextEdit** to use.

`void (No return value.)` **set_tooltip_request_func**(callback: `Callable`)

Provide custom tooltip text. The callback method must take the following args: `hovered_word: String`.

`void (No return value.)` **skip_selection_for_next_occurrence**()

Moves a selection and a caret for the next occurrence of the current selection. If there is no active selection, moves to the next occurrence of the word under caret.

`void (No return value.)` **start_action**(action: `EditAction`)
...
`void (No return value.)` **swap_lines**(from_line: `int`, to_line: `int`)

Swaps the two lines. Carets will be swapped with the lines.

`void (No return value.)` **tag_saved_version**()

Tag the current version as saved.

`void (No return value.)` **undo**()
