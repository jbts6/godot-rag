...
- `void (No return value.)` **set_attributes**(value: `CameraAttributes`)
...
- `void (No return value.)` **set_cull_mask**(value: `int`)
- `int` **get_cull_mask**()
...
- `void (No return value.)` **set_current**(value: `bool`)
- `bool` **is_current**()
...
- `void (No return value.)` **set_far**(value: `float`)
- `float` **get_far**()
...
- `void (No return value.)` **set_frustum_offset**(value: `Vector2`)
...
- `void (No return value.)` **set_h_offset**(value: `float`)
- `float` **get_h_offset**()
...
- `void (No return value.)` **set_keep_aspect_mode**(value: `KeepAspect`)
...
- `void (No return value.)` **set_near**(value: `float`)
- `float` **get_near**()
...
- `void (No return value.)` **set_projection**(value: `ProjectionType`)
...
- `void (No return value.)` **set_size**(value: `float`)
- `float` **get_size**()
...
- `void (No return value.)` **set_v_offset**(value: `float`)
- `float` **get_v_offset**()
...
`void (No return value.)` **clear_current**(enable_next: `bool` = true)
...
`void (No return value.)` **set_cull_mask_value**(layer_number: `int`, value: `bool`)

Based on `value`, enables or disables the specified layer in the `cull_mask`, given a `layer_number` between 1 and 20.

`void (No return value.)` **set_frustum**(size: `float`, offset: `Vector2`, z_near: `float`, z_far: `float`)
...
`void (No return value.)` **set_orthogonal**(size: `float`, z_near: `float`, z_far: `float`)
...
`void (No return value.)` **set_perspective**(fov: `float`, z_near: `float`, z_far: `float`)
