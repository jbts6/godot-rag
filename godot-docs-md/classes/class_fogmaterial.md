...
- `void (No return value.)` **set_density**(value: `float`)
- `float` **get_density**()
...
- `void (No return value.)` **set_density_texture**(value: `Texture3D`)
...
- `void (No return value.)` **set_edge_fade**(value: `float`)
- `float` **get_edge_fade**()
...
- `void (No return value.)` **set_height_falloff**(value: `float`)
