...
- `void (No return value.)` **set_begin_cap_mode**(value: `LineCapMode`)
...
- `void (No return value.)` **set_default_color**(value: `Color`)
...
- `void (No return value.)` **set_end_cap_mode**(value: `LineCapMode`)
...
- `void (No return value.)` **set_joint_mode**(value: `LineJointMode`)
...
- `void (No return value.)` **set_points**(value: `PackedVector2Array`)
...
- `void (No return value.)` **set_round_precision**(value: `int`)
...
- `void (No return value.)` **set_sharp_limit**(value: `float`)
...
- `void (No return value.)` **set_texture_mode**(value: `LineTextureMode`)
...
- `void (No return value.)` **set_curve**(value: `Curve`)
- `Curve` **get_curve**()
...
`void (No return value.)` **add_point**(position: `Vector2`, index: `int` = -1)
...
`void (No return value.)` **set_point_position**(index: `int`, position: `Vector2`)
