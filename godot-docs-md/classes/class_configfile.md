...
`void (No return value.)` **erase_section**(section: `String`)

Deletes the specified section along with all the key-value pairs inside. Raises an error if the section does not exist.

`void (No return value.)` **erase_section_key**(section: `String`, key: `String`)
...
`void (No return value.)` **set_value**(section: `String`, key: `String`, value: `Variant`)
