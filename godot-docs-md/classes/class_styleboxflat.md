...
- `void (No return value.)` **set_anti_aliased**(value: `bool`)
...
- `void (No return value.)` **set_aa_size**(value: `float`)
- `float` **get_aa_size**()
...
- `void (No return value.)` **set_border_blend**(value: `bool`)
...
- `void (No return value.)` **set_border_width**(margin: `Side`, width: `int`)
...
- `void (No return value.)` **set_corner_detail**(value: `int`)
...
- `void (No return value.)` **set_corner_radius**(corner: `Corner`, radius: `int`)
...
- `void (No return value.)` **set_skew**(value: `Vector2`)
- `Vector2` **get_skew**()
...
`void (No return value.)` **set_border_width_all**(width: `int`)
...
`void (No return value.)` **set_corner_radius_all**(radius: `int`)
