...
- `void (No return value.)` **set_param**(value: `float`)
- `float` **get_param**()
...
- `void (No return value.)` **set_area_normalize_energy**(value: `bool`)
...
- `void (No return value.)` **set_area_size**(value: `Vector2`)
...
- `void (No return value.)` **set_area_texture**(value: `Texture2D`)
