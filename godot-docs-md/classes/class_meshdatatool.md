...
`void (No return value.)` **set_edge_meta**(idx: `int`, meta: `Variant`)

Sets the metadata of the given edge.

`void (No return value.)` **set_face_meta**(idx: `int`, meta: `Variant`)
...
`void (No return value.)` **set_vertex**(idx: `int`, vertex: `Vector3`)

Sets the position of the given vertex.

`void (No return value.)` **set_vertex_bones**(idx: `int`, bones: `PackedInt32Array`)

Sets the bones of the given vertex.

`void (No return value.)` **set_vertex_color**(idx: `int`, color: `Color`)

Sets the color of the given vertex.

`void (No return value.)` **set_vertex_meta**(idx: `int`, meta: `Variant`)

Sets the metadata associated with the given vertex.

`void (No return value.)` **set_vertex_normal**(idx: `int`, normal: `Vector3`)

Sets the normal of the given vertex.

`void (No return value.)` **set_vertex_tangent**(idx: `int`, tangent: `Plane`)
...
`void (No return value.)` **set_vertex_uv**(idx: `int`, uv: `Vector2`)

Sets the UV of the given vertex.

`void (No return value.)` **set_vertex_uv2**(idx: `int`, uv2: `Vector2`)

Sets the UV2 of the given vertex.

`void (No return value.)` **set_vertex_weights**(idx: `int`, weights: `PackedFloat32Array`)
