...
- `void (No return value.)` **set_collision_enabled**(value: `bool`)
...
- `void (No return value.)` **set_navigation_enabled**(value: `bool`)
...
- `void (No return value.)` **set_navigation_visibility_mode**(value: `DebugVisibilityMode`)
...
- `void (No return value.)` **set_occlusion_enabled**(value: `bool`)
...
- `void (No return value.)` **set_physics_quadrant_size**(value: `int`)
...
- `void (No return value.)` **set_tile_map_data_from_array**(value: `PackedByteArray`)
...
- `void (No return value.)` **set_tile_set**(value: `TileSet`)
...
- `void (No return value.)` **set_use_kinematic_bodies**(value: `bool`)
...
- `void (No return value.)` **set_x_draw_order_reversed**(value: `bool`)
...
- `void (No return value.)` **set_y_sort_origin**(value: `int`)
...
`void (No return value.)` **\_tile_data_runtime_update**(coords: `Vector2i`, tile_data: `TileData`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`void (No return value.)` **\_update_cells**(coords: `Array`\[`Vector2i`\], forced_cleanup: `bool`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`bool` **\_use_tile_data_runtime_update**(coords: `Vector2i`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`void (No return value.)` **erase_cell**(coords: `Vector2i`)
...
`void (No return value.)` **notify_runtime_tile_data_update**()
...
`void (No return value.)` **set_cell**(coords: `Vector2i`, source_id: `int` = -1, atlas_coords: `Vector2i` = Vector2i(-1, -1), alternative_tile: `int` = 0)
...
`void (No return value.)` **set_cells_terrain_connect**(cells: `Array`\[`Vector2i`\], terrain_set: `int`, terrain: `int`, ignore_empty_terrains: `bool` = true)
...
`void (No return value.)` **set_cells_terrain_path**(path: `Array`\[`Vector2i`\], terrain_set: `int`, terrain: `int`, ignore_empty_terrains: `bool` = true)
...
`void (No return value.)` **set_navigation_map**(map: `RID`)

Sets a custom `map` as a `NavigationServer2D` navigation map. If not set, uses the default `World2D` navigation map instead.

`void (No return value.)` **set_pattern**(position: `Vector2i`, pattern: `TileMapPattern`)
