...
`void (No return value.)` **\_begin_handle_action**(id: `int`, secondary: `bool`) `virtual (This method should typically be overridden by the user to have any effect.)`

There is currently no description for this method. Please help us by [contributing one](https://contributing.godotengine.org/en/latest/documentation/class_reference.html)!

`void (No return value.)` **\_commit_handle**(id: `int`, secondary: `bool`, restore: `Variant`, cancel: `bool`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`void (No return value.)` **\_commit_subgizmos**(ids: `PackedInt32Array`, restores: `Array`\[`Transform3D`\], cancel: `bool`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`String` **\_get_handle_name**(id: `int`, secondary: `bool`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`Variant` **\_get_handle_value**(id: `int`, secondary: `bool`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`Transform3D` **\_get_subgizmo_transform**(id: `int`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`bool` **\_is_handle_highlighted**(id: `int`, secondary: `bool`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`

Override this method to return `true` whenever the given handle should be highlighted in the editor.

The `secondary` argument is `true` when the requested handle is secondary (see `add_handles()` for more information).

`void (No return value.)` **\_redraw**() `virtual (This method should typically be overridden by the user to have any effect.)`
...
`void (No return value.)` **\_set_handle**(id: `int`, secondary: `bool`, camera: `Camera3D`, point: `Vector2`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`void (No return value.)` **\_set_subgizmo_transform**(id: `int`, transform: `Transform3D`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`PackedInt32Array` **\_subgizmos_intersect_frustum**(camera: `Camera3D`, frustum: `Array`\[`Plane`\]) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`int` **\_subgizmos_intersect_ray**(camera: `Camera3D`, point: `Vector2`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`void (No return value.)` **add_collision_segments**(segments: `PackedVector3Array`)

Adds the specified `segments` to the gizmo's collision shape for picking. Call this method during `_redraw()`.

`void (No return value.)` **add_collision_triangles**(triangles: `TriangleMesh`)
...
`void (No return value.)` **add_handles**(handles: `PackedVector3Array`, material: `Material`, ids: `PackedInt32Array`, billboard: `bool` = false, secondary: `bool` = false)
...
`void (No return value.)` **add_lines**(lines: `PackedVector3Array`, material: `Material`, billboard: `bool` = false, modulate: `Color` = Color(1, 1, 1, 1))
...
`void (No return value.)` **add_mesh**(mesh: `Mesh`, material: `Material` = null, transform: `Transform3D` = Transform3D(1, 0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0), skeleton: `SkinReference` = null)

Adds a mesh to the gizmo with the specified `material`, local `transform` and `skeleton`. Call this method during `_redraw()`.

`void (No return value.)` **add_unscaled_billboard**(material: `Material`, default_scale: `float` = 1, modulate: `Color` = Color(1, 1, 1, 1))
...
`void (No return value.)` **set_hidden**(hidden: `bool`)

Sets the gizmo's hidden state. If `true`, the gizmo will be hidden. If `false`, it will be shown.

`void (No return value.)` **set_node_3d**(node: `Node`)
