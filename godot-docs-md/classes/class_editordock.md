...
`BitField (This value is an integer composed as a bitmask of the following flags.)`\[`DockLayout`\] **available_layouts** = `5`

- `void (No return value.)` **set_available_layouts**(value: `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`DockLayout`\])
- `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`DockLayout`\] **get_available_layouts**()

The available layouts for this dock, as a bitmask. By default, the dock allows vertical and floating layouts.

`bool` **closable** = `false`

- `void (No return value.)` **set_closable**(value: `bool`)
- `bool` **is_closable**()
...
- `void (No return value.)` **set_default_slot**(value: `DockSlot`)
...
- `void (No return value.)` **set_dock_icon**(value: `Texture2D`)
...
- `void (No return value.)` **set_dock_shortcut**(value: `Shortcut`)
...
- `void (No return value.)` **set_force_show_icon**(value: `bool`)
...
- `void (No return value.)` **set_global**(value: `bool`)
- `bool` **is_global**()
...
- `void (No return value.)` **set_icon_name**(value: `StringName`)
...
- `void (No return value.)` **set_layout_key**(value: `String`)
...
- `void (No return value.)` **set_title_color**(value: `Color`)
...
`void (No return value.)` **\_load_layout_from_config**(config: `ConfigFile`, section: `String`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`void (No return value.)` **\_save_layout_to_config**(config: `ConfigFile`, section: `String`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`void (No return value.)` **\_update_layout**(layout: `int`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`void (No return value.)` **make_visible**()
