...
- `void (No return value.)` **set_pose_name**(value: `StringName`)
...
- `void (No return value.)` **set_show_when_tracked**(value: `bool`)
...
- `void (No return value.)` **set_tracker**(value: `StringName`)
...
`void (No return value.)` **trigger_haptic_pulse**(action_name: `String`, frequency: `float`, amplitude: `float`, duration_sec: `float`, delay_sec: `float`)
