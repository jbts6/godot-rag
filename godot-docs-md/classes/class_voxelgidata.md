...
- `void (No return value.)` **set_dynamic_range**(value: `float`)
...
- `void (No return value.)` **set_normal_bias**(value: `float`)
...
- `void (No return value.)` **set_propagation**(value: `float`)
...
- `void (No return value.)` **set_use_two_bounces**(value: `bool`)
...
`void (No return value.)` **allocate**(to_cell_xform: `Transform3D`, aabb: `AABB`, octree_size: `Vector3`, octree_cells: `PackedByteArray`, data_cells: `PackedByteArray`, distance_field: `PackedByteArray`, level_counts: `PackedInt32Array`)
