...
- `void (No return value.)` **set_affect_navigation_mesh**(value: `bool`)
...
- `void (No return value.)` **set_carve_navigation_mesh**(value: `bool`)
...
- `void (No return value.)` **set_vertices**(value: `PackedVector3Array`)
