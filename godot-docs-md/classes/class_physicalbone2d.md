...
- `void (No return value.)` **set_auto_configure_joint**(value: `bool`)
...
- `void (No return value.)` **set_bone2d_index**(value: `int`)
...
- `void (No return value.)` **set_bone2d_nodepath**(value: `NodePath`)
...
- `void (No return value.)` **set_follow_bone_when_simulating**(value: `bool`)
...
- `void (No return value.)` **set_simulate_physics**(value: `bool`)
