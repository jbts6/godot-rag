...
- `void (No return value.)` **set_pickable**(value: `bool`)
- `bool` **is_pickable**()
...
`void (No return value.)` **\_input_event**(viewport: `Viewport`, event: `InputEvent`, shape_idx: `int`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`void (No return value.)` **\_mouse_enter**() `virtual (This method should typically be overridden by the user to have any effect.)`
...
`void (No return value.)` **\_mouse_exit**() `virtual (This method should typically be overridden by the user to have any effect.)`
...
`void (No return value.)` **\_mouse_shape_enter**(shape_idx: `int`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`void (No return value.)` **\_mouse_shape_exit**(shape_idx: `int`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`void (No return value.)` **remove_shape_owner**(owner_id: `int`)
...
`void (No return value.)` **shape_owner_add_shape**(owner_id: `int`, shape: `Shape2D`)

Adds a `Shape2D` to the shape owner.

`void (No return value.)` **shape_owner_clear_shapes**(owner_id: `int`)
...
`void (No return value.)` **shape_owner_remove_shape**(owner_id: `int`, shape_id: `int`)

Removes a shape from the given shape owner.

`void (No return value.)` **shape_owner_set_disabled**(owner_id: `int`, disabled: `bool`)

If `true`, disables the given shape owner.

`void (No return value.)` **shape_owner_set_one_way_collision**(owner_id: `int`, enable: `bool`)
...
`void (No return value.)` **shape_owner_set_one_way_collision_direction**(owner_id: `int`, direction: `Vector2`)

Sets the `one_way_collision_direction` of the shape owner identified by the given `owner_id` to `direction`.

`void (No return value.)` **shape_owner_set_one_way_collision_margin**(owner_id: `int`, margin: `float`)

Sets the `one_way_collision_margin` of the shape owner identified by given `owner_id` to `margin` pixels.

`void (No return value.)` **shape_owner_set_transform**(owner_id: `int`, transform: `Transform2D`)
