...
`void (No return value.)` **agent_set_position**(agent: `RID`, position: `Vector2`)
...
`void (No return value.)` **agent_set_velocity**(agent: `RID`, velocity: `Vector2`)
...
`void (No return value.)` **agent_set_velocity_forced**(agent: `RID`, velocity: `Vector2`)
...
`void (No return value.)` **bake_from_source_geometry_data**(navigation_polygon: `NavigationPolygon`, source_geometry_data: `NavigationMeshSourceGeometryData2D`, callback: `Callable` = Callable())
...
`void (No return value.)` **bake_from_source_geometry_data_async**(navigation_polygon: `NavigationPolygon`, source_geometry_data: `NavigationMeshSourceGeometryData2D`, callback: `Callable` = Callable())
...
`void (No return value.)` **link_set_end_position**(link: `RID`, position: `Vector2`)
...
`void (No return value.)` **link_set_start_position**(link: `RID`, position: `Vector2`)
...
`void (No return value.)` **obstacle_set_position**(obstacle: `RID`, position: `Vector2`)
...
`void (No return value.)` **obstacle_set_velocity**(obstacle: `RID`, velocity: `Vector2`)
...
`void (No return value.)` **obstacle_set_vertices**(obstacle: `RID`, vertices: `PackedVector2Array`)

Sets the outline vertices for the obstacle. If the vertices are winded in clockwise order agents will be pushed in by the obstacle, else they will be pushed out.

`void (No return value.)` **parse_source_geometry_data**(navigation_polygon: `NavigationPolygon`, source_geometry_data: `NavigationMeshSourceGeometryData2D`, root_node: `Node`, callback: `Callable` = Callable())
...
`void (No return value.)` **query_path**(parameters: `NavigationPathQueryParameters2D`, result: `NavigationPathQueryResult2D`, callback: `Callable` = Callable())
...
`void (No return value.)` **region_set_navigation_polygon**(region: `RID`, navigation_polygon: `NavigationPolygon`)
...
`void (No return value.)` **region_set_transform**(region: `RID`, transform: `Transform2D`)
