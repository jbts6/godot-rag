...
- `void (No return value.)` **set_enable_alpha_to_coverage**(value: `bool`)
...
- `void (No return value.)` **set_enable_alpha_to_one**(value: `bool`)
...
- `void (No return value.)` **set_enable_sample_shading**(value: `bool`)
...
- `void (No return value.)` **set_min_sample_shading**(value: `float`)
...
- `void (No return value.)` **set_sample_count**(value: `TextureSamples`)
...
- `void (No return value.)` **set_sample_masks**(value: `Array`\[`int`\])
