...
- `void (No return value.)` **set_accept_gzip**(value: `bool`)
...
- `void (No return value.)` **set_body_size_limit**(value: `int`)
...
- `void (No return value.)` **set_download_chunk_size**(value: `int`)
...
- `void (No return value.)` **set_download_file**(value: `String`)
...
- `void (No return value.)` **set_max_redirects**(value: `int`)
...
- `void (No return value.)` **set_timeout**(value: `float`)
- `float` **get_timeout**()
...
- `void (No return value.)` **set_use_threads**(value: `bool`)
...
`void (No return value.)` **cancel_request**()
...
`void (No return value.)` **set_http_proxy**(host: `String`, port: `int`)

Sets the proxy server for HTTP requests.

The proxy server is unset if `host` is empty or `port` is -1.

`void (No return value.)` **set_https_proxy**(host: `String`, port: `int`)

Sets the proxy server for HTTPS requests.

The proxy server is unset if `host` is empty or `port` is -1.

`void (No return value.)` **set_tls_options**(client_options: `TLSOptions`)
