...
- `void (No return value.)` **set_adjustment_brightness**(value: `float`)
...
- `void (No return value.)` **set_adjustment_color_correction**(value: `Texture`)
...
- `void (No return value.)` **set_adjustment_contrast**(value: `float`)
...
- `void (No return value.)` **set_adjustment_enabled**(value: `bool`)
...
- `void (No return value.)` **set_adjustment_saturation**(value: `float`)
...
- `void (No return value.)` **set_ambient_light_color**(value: `Color`)
...
- `void (No return value.)` **set_ambient_light_energy**(value: `float`)
...
- `void (No return value.)` **set_ambient_light_sky_contribution**(value: `float`)
...
- `void (No return value.)` **set_ambient_source**(value: `AmbientSource`)
...
- `void (No return value.)` **set_canvas_max_layer**(value: `int`)
...
- `void (No return value.)` **set_bg_color**(value: `Color`)
- `Color` **get_bg_color**()
...
- `void (No return value.)` **set_bg_energy_multiplier**(value: `float`)
...
- `void (No return value.)` **set_bg_intensity**(value: `float`)
...
- `void (No return value.)` **set_background**(value: `BGMode`)
...
- `void (No return value.)` **set_fog_aerial_perspective**(value: `float`)
...
- `void (No return value.)` **set_fog_density**(value: `float`)
...
- `void (No return value.)` **set_fog_depth_begin**(value: `float`)
...
- `void (No return value.)` **set_fog_depth_curve**(value: `float`)
...
- `void (No return value.)` **set_fog_depth_end**(value: `float`)
...
- `void (No return value.)` **set_fog_enabled**(value: `bool`)
- `bool` **is_fog_enabled**()
...
- `void (No return value.)` **set_fog_height**(value: `float`)
...
- `void (No return value.)` **set_fog_height_density**(value: `float`)
...
- `void (No return value.)` **set_fog_light_color**(value: `Color`)
...
- `void (No return value.)` **set_fog_light_energy**(value: `float`)
...
- `void (No return value.)` **set_fog_mode**(value: `FogMode`)
...
- `void (No return value.)` **set_fog_sky_affect**(value: `float`)
...
- `void (No return value.)` **set_fog_sun_scatter**(value: `float`)
...
- `void (No return value.)` **set_glow_blend_mode**(value: `GlowBlendMode`)
...
- `void (No return value.)` **set_glow_bloom**(value: `float`)
...
- `void (No return value.)` **set_glow_enabled**(value: `bool`)
...
- `void (No return value.)` **set_glow_hdr_luminance_cap**(value: `float`)
...
- `void (No return value.)` **set_glow_hdr_bleed_scale**(value: `float`)
...
- `void (No return value.)` **set_glow_hdr_bleed_threshold**(value: `float`)
...
- `void (No return value.)` **set_glow_intensity**(value: `float`)
...
- `void (No return value.)` **set_glow_level**(idx: `int`, intensity: `float`)
...
- `void (No return value.)` **set_glow_map**(value: `Texture`)
...
- `void (No return value.)` **set_glow_map_strength**(value: `float`)
...
- `void (No return value.)` **set_glow_mix**(value: `float`)
- `float` **get_glow_mix**()
...
- `void (No return value.)` **set_glow_normalized**(value: `bool`)
...
- `void (No return value.)` **set_glow_strength**(value: `float`)
...
- `void (No return value.)` **set_reflection_source**(value: `ReflectionSource`)
...
- `void (No return value.)` **set_sdfgi_bounce_feedback**(value: `float`)
...
- `void (No return value.)` **set_sdfgi_cascade0_distance**(value: `float`)
...
- `void (No return value.)` **set_sdfgi_cascades**(value: `int`)
...
- `void (No return value.)` **set_sdfgi_enabled**(value: `bool`)
...
- `void (No return value.)` **set_sdfgi_energy**(value: `float`)
...
- `void (No return value.)` **set_sdfgi_max_distance**(value: `float`)
...
- `void (No return value.)` **set_sdfgi_min_cell_size**(value: `float`)
...
- `void (No return value.)` **set_sdfgi_normal_bias**(value: `float`)
...
- `void (No return value.)` **set_sdfgi_probe_bias**(value: `float`)
...
- `void (No return value.)` **set_sdfgi_read_sky_light**(value: `bool`)
...
- `void (No return value.)` **set_sdfgi_use_occlusion**(value: `bool`)
...
- `void (No return value.)` **set_sdfgi_y_scale**(value: `SDFGIYScale`)
...
- `void (No return value.)` **set_sky**(value: `Sky`)
- `Sky` **get_sky**()
...
- `void (No return value.)` **set_sky_custom_fov**(value: `float`)
...
- `void (No return value.)` **set_sky_rotation**(value: `Vector3`)
...
- `void (No return value.)` **set_ssao_ao_channel_affect**(value: `float`)
...
- `void (No return value.)` **set_ssao_detail**(value: `float`)
...
- `void (No return value.)` **set_ssao_enabled**(value: `bool`)
...
- `void (No return value.)` **set_ssao_horizon**(value: `float`)
...
- `void (No return value.)` **set_ssao_intensity**(value: `float`)
...
- `void (No return value.)` **set_ssao_direct_light_affect**(value: `float`)
...
- `void (No return value.)` **set_ssao_power**(value: `float`)
...
- `void (No return value.)` **set_ssao_radius**(value: `float`)
...
- `void (No return value.)` **set_ssao_sharpness**(value: `float`)
...
- `void (No return value.)` **set_ssil_enabled**(value: `bool`)
...
- `void (No return value.)` **set_ssil_intensity**(value: `float`)
...
- `void (No return value.)` **set_ssil_normal_rejection**(value: `float`)
...
- `void (No return value.)` **set_ssil_radius**(value: `float`)
...
- `void (No return value.)` **set_ssil_sharpness**(value: `float`)
...
- `void (No return value.)` **set_ssr_depth_tolerance**(value: `float`)
...
- `void (No return value.)` **set_ssr_enabled**(value: `bool`)
- `bool` **is_ssr_enabled**()
...
- `void (No return value.)` **set_ssr_fade_in**(value: `float`)
...
- `void (No return value.)` **set_ssr_fade_out**(value: `float`)
...
- `void (No return value.)` **set_ssr_max_steps**(value: `int`)
...
- `void (No return value.)` **set_tonemap_agx_contrast**(value: `float`)
...
- `void (No return value.)` **set_tonemap_agx_white**(value: `float`)
...
- `void (No return value.)` **set_tonemap_exposure**(value: `float`)
...
- `void (No return value.)` **set_tonemapper**(value: `ToneMapper`)
...
- `void (No return value.)` **set_tonemap_white**(value: `float`)
...
- `void (No return value.)` **set_volumetric_fog_albedo**(value: `Color`)
...
- `void (No return value.)` **set_volumetric_fog_ambient_inject**(value: `float`)
...
- `void (No return value.)` **set_volumetric_fog_anisotropy**(value: `float`)
...
- `void (No return value.)` **set_volumetric_fog_density**(value: `float`)
...
- `void (No return value.)` **set_volumetric_fog_detail_spread**(value: `float`)
...
- `void (No return value.)` **set_volumetric_fog_emission**(value: `Color`)
...
- `void (No return value.)` **set_volumetric_fog_emission_energy**(value: `float`)
...
- `void (No return value.)` **set_volumetric_fog_enabled**(value: `bool`)
...
- `void (No return value.)` **set_volumetric_fog_gi_inject**(value: `float`)
...
- `void (No return value.)` **set_volumetric_fog_length**(value: `float`)
...
- `void (No return value.)` **set_volumetric_fog_sky_affect**(value: `float`)
...
- `void (No return value.)` **set_volumetric_fog_temporal_reprojection_amount**(value: `float`)
...
- `void (No return value.)` **set_volumetric_fog_temporal_reprojection_enabled**(value: `bool`)
