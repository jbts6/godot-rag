...
`void (No return value.)` **clear_selection**()
...
`void (No return value.)` **set_selected_palette_item**(item: `int`) `const`
...
`void (No return value.)` **set_selection**(begin: `Vector3i`, end: `Vector3i`)
