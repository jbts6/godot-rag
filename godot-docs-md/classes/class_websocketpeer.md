...
- `void (No return value.)` **set_handshake_headers**(value: `PackedStringArray`)
...
- `void (No return value.)` **set_heartbeat_interval**(value: `float`)
...
- `void (No return value.)` **set_inbound_buffer_size**(value: `int`)
...
- `void (No return value.)` **set_max_queued_packets**(value: `int`)
...
- `void (No return value.)` **set_outbound_buffer_size**(value: `int`)
...
- `void (No return value.)` **set_supported_protocols**(value: `PackedStringArray`)
...
`void (No return value.)` **close**(code: `int` = 1000, reason: `String` = "")
