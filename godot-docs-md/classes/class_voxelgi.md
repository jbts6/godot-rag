...
- `void (No return value.)` **set_probe_data**(value: `VoxelGIData`)
...
- `void (No return value.)` **set_subdiv**(value: `Subdiv`)
- `Subdiv` **get_subdiv**()
...
`void (No return value.)` **bake**(from_node: `Node` = null, create_visual_debug: `bool` = false)
...
`void (No return value.)` **debug_bake**()
