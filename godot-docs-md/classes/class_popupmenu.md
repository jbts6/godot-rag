...
- `void (No return value.)` **set_hide_on_checkable_item_selection**(value: `bool`)
...
- `void (No return value.)` **set_hide_on_item_selection**(value: `bool`)
...
- `void (No return value.)` **set_hide_on_state_item_selection**(value: `bool`)
...
`int` **item\_{index}/checkable** = `0`

The checkable item type of the item at `index`.

**Note:** `index` is a value in the `0 .. item_count - 1` range.

`bool` **item\_{index}/checked** = `false`
...
`int` **item\_{index}/id** = `0`

The ID of the item at `index`.

**Note:** `index` is a value in the `0 .. item_count - 1` range.

`bool` **item\_{index}/separator** = `false`
...
- `void (No return value.)` **set_prefer_native_menu**(value: `bool`)
...
- `void (No return value.)` **set_shrink_height**(value: `bool`)
...
- `void (No return value.)` **set_shrink_width**(value: `bool`)
...
- `void (No return value.)` **set_submenu_popup_delay**(value: `float`)
...
- `void (No return value.)` **set_system_menu**(value: `SystemMenus`)
...
`void (No return value.)` **add_check_item**(label: `String`, id: `int` = -1, accel: `Key` = 0)
...
`void (No return value.)` **add_check_shortcut**(shortcut: `Shortcut`, id: `int` = -1, global: `bool` = false)
...
`void (No return value.)` **add_icon_check_item**(texture: `Texture2D`, label: `String`, id: `int` = -1, accel: `Key` = 0)
...
`void (No return value.)` **add_icon_check_shortcut**(texture: `Texture2D`, shortcut: `Shortcut`, id: `int` = -1, global: `bool` = false)
...
`void (No return value.)` **add_icon_item**(texture: `Texture2D`, label: `String`, id: `int` = -1, accel: `Key` = 0)

Adds a new item with text `label` and icon `texture`.

An `id` can optionally be provided, as well as an accelerator (`accel`). If no `id` is provided, one will be created from the index. If no `accel` is provided, then the default value of 0 (corresponding to `@GlobalScope.KEY_NONE`) will be assigned to the item (which means it won't have any accelerator). See `get_item_accelerator()` for more info on accelerators.

`void (No return value.)` **add_icon_radio_check_item**(texture: `Texture2D`, label: `String`, id: `int` = -1, accel: `Key` = 0)

Same as `add_icon_check_item()`, but uses a radio check button.

`void (No return value.)` **add_icon_radio_check_shortcut**(texture: `Texture2D`, shortcut: `Shortcut`, id: `int` = -1, global: `bool` = false)

Same as `add_icon_check_shortcut()`, but uses a radio check button.

`void (No return value.)` **add_icon_shortcut**(texture: `Texture2D`, shortcut: `Shortcut`, id: `int` = -1, global: `bool` = false, allow_echo: `bool` = false)
...
`void (No return value.)` **add_item**(label: `String`, id: `int` = -1, accel: `Key` = 0)
...
`void (No return value.)` **add_multistate_item**(label: `String`, max_states: `int`, default_state: `int` = 0, id: `int` = -1, accel: `Key` = 0)
...
`void (No return value.)` **add_radio_check_item**(label: `String`, id: `int` = -1, accel: `Key` = 0)
...
`void (No return value.)` **add_radio_check_shortcut**(shortcut: `Shortcut`, id: `int` = -1, global: `bool` = false)
...
`void (No return value.)` **add_separator**(label: `String` = "", id: `int` = -1)

Adds a separator between items. Separators also occupy an index, which you can set by using the `id` parameter.

A `label` can optionally be provided, which will appear at the center of the separator.

`void (No return value.)` **add_shortcut**(shortcut: `Shortcut`, id: `int` = -1, global: `bool` = false, allow_echo: `bool` = false)
...
`void (No return value.)` **add_submenu_item**(label: `String`, submenu: `String`, id: `int` = -1)
...
`void (No return value.)` **add_submenu_node_item**(label: `String`, submenu: `PopupMenu`, id: `int` = -1)
...
`void (No return value.)` **clear**(free_submenus: `bool` = false)
...
`void (No return value.)` **remove_item**(index: `int`)

Removes the item at the given `index` from the menu.

**Note:** The indices of items after the removed item will be shifted by one.

`void (No return value.)` **scroll_to_item**(index: `int`)

Moves the scroll view to make the item at the given `index` visible.

`void (No return value.)` **set_focused_item**(index: `int`)

Sets the currently focused item as the given `index`.

Passing `-1` as the index makes so that no item is focused.

`void (No return value.)` **set_item_accelerator**(index: `int`, accel: `Key`)
...
`void (No return value.)` **set_item_as_checkable**(index: `int`, enable: `bool`)
...
`void (No return value.)` **set_item_as_radio_checkable**(index: `int`, enable: `bool`)

Sets the type of the item at the given `index` to radio button. If `false`, sets the type of the item to plain text.

`void (No return value.)` **set_item_as_separator**(index: `int`, enable: `bool`)
...
`void (No return value.)` **set_item_auto_translate_mode**(index: `int`, mode: `AutoTranslateMode`)
...
`void (No return value.)` **set_item_checked**(index: `int`, checked: `bool`)

Sets the checkstate status of the item at the given `index`.

`void (No return value.)` **set_item_disabled**(index: `int`, disabled: `bool`)

Enables/disables the item at the given `index`. When it is disabled, it can't be selected and its action can't be invoked.

`void (No return value.)` **set_item_icon**(index: `int`, icon: `Texture2D`)

Replaces the `Texture2D` icon of the item at the given `index`.

`void (No return value.)` **set_item_icon_max_width**(index: `int`, width: `int`)
...
`void (No return value.)` **set_item_icon_modulate**(index: `int`, modulate: `Color`)

Sets a modulating `Color` of the item's icon at the given `index`.

`void (No return value.)` **set_item_id**(index: `int`, id: `int`)

Sets the `id` of the item at the given `index`.

The `id` is used in `id_pressed` and `id_focused` signals.

`void (No return value.)` **set_item_indent**(index: `int`, indent: `int`)

Sets the horizontal offset of the item at the given `index`.

`void (No return value.)` **set_item_index**(index: `int`, target_index: `int`)
...
`void (No return value.)` **set_item_language**(index: `int`, language: `String`)
...
`void (No return value.)` **set_item_metadata**(index: `int`, metadata: `Variant`)
...
`void (No return value.)` **set_item_multistate**(index: `int`, state: `int`)

Sets the state of a multistate item. See `add_multistate_item()` for details.

`void (No return value.)` **set_item_multistate_max**(index: `int`, max_states: `int`)

Sets the max states of a multistate item. See `add_multistate_item()` for details.

`void (No return value.)` **set_item_shortcut**(index: `int`, shortcut: `Shortcut`, global: `bool` = false)

Sets a `Shortcut` for the item at the given `index`.

`void (No return value.)` **set_item_shortcut_disabled**(index: `int`, disabled: `bool`)

Disables the `Shortcut` of the item at the given `index`.

`void (No return value.)` **set_item_submenu**(index: `int`, submenu: `String`)
...
`void (No return value.)` **set_item_submenu_node**(index: `int`, submenu: `PopupMenu`)
...
`void (No return value.)` **set_item_text**(index: `int`, text: `String`)

Sets the text of the item at the given `index`.

`void (No return value.)` **set_item_text_direction**(index: `int`, direction: `TextDirection`)

Sets item's text base writing direction.

`void (No return value.)` **set_item_tooltip**(index: `int`, tooltip: `String`)

Sets the `String` tooltip of the item at the given `index`.

`void (No return value.)` **toggle_item_checked**(index: `int`)

Toggles the check state of the item at the given `index`.

`void (No return value.)` **toggle_item_multistate**(index: `int`)
