...
- `void (No return value.)` **set_ground_bottom_color**(value: `Color`)
...
- `void (No return value.)` **set_ground_curve**(value: `float`)
...
- `void (No return value.)` **set_ground_energy_multiplier**(value: `float`)
...
- `void (No return value.)` **set_ground_horizon_color**(value: `Color`)
...
- `void (No return value.)` **set_sky_cover**(value: `Texture2D`)
...
- `void (No return value.)` **set_sky_cover_modulate**(value: `Color`)
...
- `void (No return value.)` **set_sky_curve**(value: `float`)
- `float` **get_sky_curve**()
...
- `void (No return value.)` **set_sky_energy_multiplier**(value: `float`)
...
- `void (No return value.)` **set_sky_horizon_color**(value: `Color`)
...
- `void (No return value.)` **set_sky_top_color**(value: `Color`)
...
- `void (No return value.)` **set_sun_angle_max**(value: `float`)
...
- `void (No return value.)` **set_sun_curve**(value: `float`)
- `float` **get_sun_curve**()
