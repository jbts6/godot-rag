...
- `void (No return value.)` **set_path_continuous_u**(value: `bool`)
...
- `void (No return value.)` **set_path_interval**(value: `float`)
...
- `void (No return value.)` **set_path_interval_type**(value: `PathIntervalType`)
...
- `void (No return value.)` **set_path_joined**(value: `bool`)
- `bool` **is_path_joined**()
...
- `void (No return value.)` **set_path_local**(value: `bool`)
- `bool` **is_path_local**()
...
- `void (No return value.)` **set_path_node**(value: `NodePath`)
...
- `void (No return value.)` **set_path_rotation**(value: `PathRotation`)
...
- `void (No return value.)` **set_path_rotation_accurate**(value: `bool`)
...
- `void (No return value.)` **set_path_simplify_angle**(value: `float`)
...
- `void (No return value.)` **set_path_u_distance**(value: `float`)
...
- `void (No return value.)` **set_spin_degrees**(value: `float`)
...
- `void (No return value.)` **set_spin_sides**(value: `int`)
- `int` **get_spin_sides**()
