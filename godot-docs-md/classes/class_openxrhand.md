...
- `void (No return value.)` **set_hand**(value: `Hands`)
- `Hands` **get_hand**()
...
- `void (No return value.)` **set_hand_skeleton**(value: `NodePath`)
...
- `void (No return value.)` **set_motion_range**(value: `MotionRange`)
...
- `void (No return value.)` **set_skeleton_rig**(value: `SkeletonRig`)
