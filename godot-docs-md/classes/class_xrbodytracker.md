...
`BitField (This value is an integer composed as a bitmask of the following flags.)`\[`BodyFlags`\] **body_flags** = `0`

- `void (No return value.)` **set_body_flags**(value: `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`BodyFlags`\])
- `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`BodyFlags`\] **get_body_flags**()
...
`BitField (This value is an integer composed as a bitmask of the following flags.)`\[`JointFlags`\] **get_joint_flags**(joint: `Joint`) `const`
...
`void (No return value.)` **set_joint_flags**(joint: `Joint`, flags: `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`JointFlags`\])

Sets flags about the validity of the tracking data for the given body joint.

`void (No return value.)` **set_joint_transform**(joint: `Joint`, transform: `Transform3D`)
