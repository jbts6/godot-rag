...
`bool` **\_exists**(path: `String`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`

There is currently no description for this method. Please help us by [contributing one](https://contributing.godotengine.org/en/latest/documentation/class_reference.html)!

`PackedStringArray` **\_get_classes_used**(path: `String`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`

There is currently no description for this method. Please help us by [contributing one](https://contributing.godotengine.org/en/latest/documentation/class_reference.html)!

`PackedStringArray` **\_get_dependencies**(path: `String`, add_types: `bool`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`String` **\_get_resource_script_class**(path: `String`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`String` **\_get_resource_type**(path: `String`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`int` **\_get_resource_uid**(path: `String`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`bool` **\_handles_type**(type: `StringName`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`Variant` **\_load**(path: `String`, original_path: `String`, use_sub_threads: `bool`, cache_mode: `int`) `virtual (This method should typically be overridden by the user to have any effect.)` `required (This method is required to be overridden when extending its base class.)` `const`
...
`bool` **\_recognize_path**(path: `String`, type: `StringName`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`Error` **\_rename_dependencies**(path: `String`, renames: `Dictionary`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
