...
- `void (No return value.)` **set_buffer**(value: `PackedFloat32Array`)
...
- `void (No return value.)` **set_instance_count**(value: `int`)
...
- `void (No return value.)` **set_physics_interpolation_quality**(value: `PhysicsInterpolationQuality`)
...
- `void (No return value.)` **set_transform_format**(value: `TransformFormat`)
...
- `void (No return value.)` **set_use_colors**(value: `bool`)
...
- `void (No return value.)` **set_use_custom_data**(value: `bool`)
...
- `void (No return value.)` **set_visible_instance_count**(value: `int`)
...
`void (No return value.)` **reset_instance_physics_interpolation**(instance: `int`)
...
`void (No return value.)` **reset_instances_physics_interpolation**()
...
`void (No return value.)` **set_buffer_interpolated**(buffer_curr: `PackedFloat32Array`, buffer_prev: `PackedFloat32Array`)
...
`void (No return value.)` **set_instance_color**(instance: `int`, color: `Color`)
...
`void (No return value.)` **set_instance_custom_data**(instance: `int`, custom_data: `Color`)
...
`void (No return value.)` **set_instance_transform**(instance: `int`, transform: `Transform3D`)

Sets the `Transform3D` for a specific instance.

`void (No return value.)` **set_instance_transform_2d**(instance: `int`, transform: `Transform2D`)
