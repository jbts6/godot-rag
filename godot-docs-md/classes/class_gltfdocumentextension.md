...
`void (No return value.)` **\_convert_scene_node**(state: `GLTFState`, gltf_node: `GLTFNode`, scene_node: `Node`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`Array`\[`Dictionary`\] **\_export_get_property_list**(root_node: `Node`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`Error` **\_export_node**(state: `GLTFState`, gltf_node: `GLTFNode`, json: `Dictionary`, node: `Node`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`GLTFObjectModelProperty` **\_export_object_model_property**(state: `GLTFState`, node_path: `NodePath`, godot_node: `Node`, gltf_node_index: `int`, target_object: `Object`, target_depth: `int`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`Error` **\_export_post**(state: `GLTFState`) `virtual (This method should typically be overridden by the user to have any effect.)`

Part of the export process. This method is run last, after all other parts of the export process.

This method can be used to modify the final JSON of the generated glTF file.

`Error` **\_export_post_convert**(state: `GLTFState`, root: `Node`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`Error` **\_export_preflight**(state: `GLTFState`, root: `Node`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`Error` **\_export_preserialize**(state: `GLTFState`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`Node3D` **\_generate_scene_node**(state: `GLTFState`, gltf_node: `GLTFNode`, scene_parent: `Node`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`String` **\_get_image_file_extension**() `virtual (This method should typically be overridden by the user to have any effect.)`
...
`PackedStringArray` **\_get_saveable_image_formats**() `virtual (This method should typically be overridden by the user to have any effect.)`
...
`PackedStringArray` **\_get_supported_extensions**() `virtual (This method should typically be overridden by the user to have any effect.)`
...
`Error` **\_import_node**(state: `GLTFState`, gltf_node: `GLTFNode`, json: `Dictionary`, node: `Node`) `virtual (This method should typically be overridden by the user to have any effect.)`

Part of the import process. This method is run after `_generate_scene_node()` and before `_import_post()`.

This method can be used to make modifications to each of the generated Godot scene nodes.

`GLTFObjectModelProperty` **\_import_object_model_property**(state: `GLTFState`, split_json_pointer: `PackedStringArray`, partial_paths: `Array`\[`NodePath`\]) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`Error` **\_import_post**(state: `GLTFState`, root: `Node`) `virtual (This method should typically be overridden by the user to have any effect.)`

Part of the import process. This method is run last, after all other parts of the import process.

This method can be used to modify the final Godot scene generated by the import process.

`Error` **\_import_post_parse**(state: `GLTFState`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`Error` **\_import_pre_generate**(state: `GLTFState`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`Error` **\_import_preflight**(state: `GLTFState`, extensions: `PackedStringArray`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`Error` **\_parse_image_data**(state: `GLTFState`, image_data: `PackedByteArray`, mime_type: `String`, ret_image: `Image`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`Error` **\_parse_node_extensions**(state: `GLTFState`, gltf_node: `GLTFNode`, extensions: `Dictionary`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`Error` **\_parse_texture_json**(state: `GLTFState`, texture_json: `Dictionary`, ret_gltf_texture: `GLTFTexture`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`Error` **\_save_image_at_path**(state: `GLTFState`, image: `Image`, file_path: `String`, image_format: `String`, lossy_quality: `float`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`PackedByteArray` **\_serialize_image_to_bytes**(state: `GLTFState`, image: `Image`, image_dict: `Dictionary`, image_format: `String`, lossy_quality: `float`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`Error` **\_serialize_texture_json**(state: `GLTFState`, texture_json: `Dictionary`, gltf_texture: `GLTFTexture`, image_format: `String`) `virtual (This method should typically be overridden by the user to have any effect.)`
