...
`void (No return value.)` **add_marker**(name: `StringName`, time: `float`)
...
`void (No return value.)` **animation_track_set_key_animation**(track_idx: `int`, key_idx: `int`, animation: `StringName`)
...
`void (No return value.)` **audio_track_set_key_end_offset**(track_idx: `int`, key_idx: `int`, offset: `float`)

Sets the end offset of the key identified by `key_idx` to value `offset`. The `track_idx` must be the index of an Audio Track.

`void (No return value.)` **audio_track_set_key_start_offset**(track_idx: `int`, key_idx: `int`, offset: `float`)

Sets the start offset of the key identified by `key_idx` to value `offset`. The `track_idx` must be the index of an Audio Track.

`void (No return value.)` **audio_track_set_key_stream**(track_idx: `int`, key_idx: `int`, stream: `Resource`)

Sets the stream of the key identified by `key_idx` to value `stream`. The `track_idx` must be the index of an Audio Track.

`void (No return value.)` **audio_track_set_use_blend**(track_idx: `int`, enable: `bool`)
...
`void (No return value.)` **bezier_track_set_key_in_handle**(track_idx: `int`, key_idx: `int`, in_handle: `Vector2`, balanced_value_time_ratio: `float` = 1.0)

Sets the in handle of the key identified by `key_idx` to value `in_handle`. The `track_idx` must be the index of a Bezier Track.

`void (No return value.)` **bezier_track_set_key_out_handle**(track_idx: `int`, key_idx: `int`, out_handle: `Vector2`, balanced_value_time_ratio: `float` = 1.0)

Sets the out handle of the key identified by `key_idx` to value `out_handle`. The `track_idx` must be the index of a Bezier Track.

`void (No return value.)` **bezier_track_set_key_value**(track_idx: `int`, key_idx: `int`, value: `float`)
...
`void (No return value.)` **compress**(page_size: `int` = 8192, fps: `int` = 120, split_tolerance: `float` = 4.0)
...
`void (No return value.)` **copy_track**(track_idx: `int`, to_animation: `Animation`)
...
`void (No return value.)` **optimize**(allowed_velocity_err: `float` = 0.01, allowed_angular_err: `float` = 0.01, precision: `int` = 3)
...
`void (No return value.)` **remove_marker**(name: `StringName`)

Removes the marker with the given name from this Animation.

`void (No return value.)` **remove_track**(track_idx: `int`)
...
`void (No return value.)` **set_marker_color**(name: `StringName`, color: `Color`)
...
`void (No return value.)` **track_move_down**(track_idx: `int`)

Moves a track down.

`void (No return value.)` **track_move_to**(track_idx: `int`, to_idx: `int`)

Changes the index position of track `track_idx` to the one defined in `to_idx`.

`void (No return value.)` **track_move_up**(track_idx: `int`)

Moves a track up.

`void (No return value.)` **track_remove_key**(track_idx: `int`, key_idx: `int`)

Removes a key by index in a given track.

`void (No return value.)` **track_remove_key_at_time**(track_idx: `int`, time: `float`)

Removes a key at `time` in a given track.

`void (No return value.)` **track_set_enabled**(track_idx: `int`, enabled: `bool`)

Enables/disables the given track. Tracks are enabled by default.

`void (No return value.)` **track_set_imported**(track_idx: `int`, imported: `bool`)

Sets the given track as imported or not.

`void (No return value.)` **track_set_interpolation_loop_wrap**(track_idx: `int`, interpolation: `bool`)

If `true`, the track at `track_idx` wraps the interpolation loop.

`void (No return value.)` **track_set_interpolation_type**(track_idx: `int`, interpolation: `InterpolationType`)

Sets the interpolation type of a given track.

`void (No return value.)` **track_set_key_time**(track_idx: `int`, key_idx: `int`, time: `float`)

Sets the time of an existing key.

`void (No return value.)` **track_set_key_transition**(track_idx: `int`, key_idx: `int`, transition: `float`)

Sets the transition curve (easing) for a specific key (see the built-in math function `@GlobalScope.ease()`).

`void (No return value.)` **track_set_key_value**(track_idx: `int`, key: `int`, value: `Variant`)

Sets the value of an existing key.

`void (No return value.)` **track_set_path**(track_idx: `int`, path: `NodePath`)
...
`void (No return value.)` **track_swap**(track_idx: `int`, with_idx: `int`)
...
`void (No return value.)` **value_track_set_update_mode**(track_idx: `int`, mode: `UpdateMode`)
