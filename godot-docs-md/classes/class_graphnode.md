...
- `void (No return value.)` **set_ignore_invalid_connection_type**(value: `bool`)
...
- `void (No return value.)` **set_slots_focus_mode**(value: `FocusMode`)
...
`void (No return value.)` **\_draw_port**(slot_index: `int`, position: `Vector2i`, left: `bool`, color: `Color`) `virtual (This method should typically be overridden by the user to have any effect.)`

There is currently no description for this method. Please help us by [contributing one](https://contributing.godotengine.org/en/latest/documentation/class_reference.html)!

`void (No return value.)` **clear_all_slots**()

Disables all slots of the GraphNode. This will remove all input/output ports from the GraphNode.

`void (No return value.)` **clear_slot**(slot_index: `int`)
...
`void (No return value.)` **set_slot**(slot_index: `int`, enable_left_port: `bool`, type_left: `int`, color_left: `Color`, enable_right_port: `bool`, type_right: `int`, color_right: `Color`, custom_icon_left: `Texture2D` = null, custom_icon_right: `Texture2D` = null, draw_stylebox: `bool` = true)
...
`void (No return value.)` **set_slot_enabled_right**(slot_index: `int`, enable: `bool`)
...
`void (No return value.)` **set_slot_metadata_left**(slot_index: `int`, value: `Variant`)

Sets the custom metadata for the left (input) side of the slot with the given `slot_index` to `value`.

`void (No return value.)` **set_slot_metadata_right**(slot_index: `int`, value: `Variant`)

Sets the custom metadata for the right (output) side of the slot with the given `slot_index` to `value`.

`void (No return value.)` **set_slot_type_left**(slot_index: `int`, type: `int`)
...
`void (No return value.)` **set_slot_type_right**(slot_index: `int`, type: `int`)
