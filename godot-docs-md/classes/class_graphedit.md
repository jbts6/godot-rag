...
- `void (No return value.)` **set_connection_lines_antialiased**(value: `bool`)
...
- `void (No return value.)` **set_connection_lines_curvature**(value: `float`)
...
- `void (No return value.)` **set_connection_lines_thickness**(value: `float`)
...
- `void (No return value.)` **set_connections**(value: `Array`\[`Dictionary`\])
...
- `void (No return value.)` **set_grid_pattern**(value: `GridPattern`)
...
- `void (No return value.)` **set_minimap_enabled**(value: `bool`)
...
- `void (No return value.)` **set_minimap_opacity**(value: `float`)
...
- `void (No return value.)` **set_minimap_size**(value: `Vector2`)
...
- `void (No return value.)` **set_panning_scheme**(value: `PanningScheme`)
...
- `void (No return value.)` **set_right_disconnects**(value: `bool`)
...
- `void (No return value.)` **set_show_arrange_button**(value: `bool`)
...
- `void (No return value.)` **set_show_grid**(value: `bool`)
...
- `void (No return value.)` **set_show_grid_buttons**(value: `bool`)
...
- `void (No return value.)` **set_show_menu**(value: `bool`)
...
- `void (No return value.)` **set_show_minimap_button**(value: `bool`)
...
- `void (No return value.)` **set_show_zoom_buttons**(value: `bool`)
...
- `void (No return value.)` **set_show_zoom_label**(value: `bool`)
...
- `void (No return value.)` **set_snapping_distance**(value: `int`)
...
- `void (No return value.)` **set_snapping_enabled**(value: `bool`)
...
- `void (No return value.)` **set_type_names**(value: `Dictionary`)
...
- `void (No return value.)` **set_zoom**(value: `float`)
- `float` **get_zoom**()
...
- `void (No return value.)` **set_zoom_max**(value: `float`)
- `float` **get_zoom_max**()
...
- `void (No return value.)` **set_zoom_min**(value: `float`)
- `float` **get_zoom_min**()
...
- `void (No return value.)` **set_zoom_step**(value: `float`)
- `float` **get_zoom_step**()
...
`PackedVector2Array` **\_get_connection_line**(from_position: `Vector2`, to_position: `Vector2`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`

Virtual method which can be overridden to customize how connections are drawn.

`bool` **\_is_in_input_hotzone**(in_node: `Object`, in_port: `int`, mouse_position: `Vector2`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`bool` **\_is_in_output_hotzone**(in_node: `Object`, in_port: `int`, mouse_position: `Vector2`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`bool` **\_is_node_hover_valid**(from_node: `StringName`, from_port: `int`, to_node: `StringName`, to_port: `int`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`void (No return value.)` **add_valid_connection_type**(from_type: `int`, to_type: `int`)
...
`void (No return value.)` **add_valid_left_disconnect_type**(type: `int`)
...
`void (No return value.)` **add_valid_right_disconnect_type**(type: `int`)
...
`void (No return value.)` **arrange_nodes**()

Rearranges selected nodes in a layout with minimum crossings between connections and uniform horizontal and vertical gap between nodes.

`void (No return value.)` **attach_graph_element_to_frame**(element: `StringName`, frame: `StringName`)

Attaches the `element` `GraphElement` to the `frame` `GraphFrame`.

`void (No return value.)` **clear_connections**()
...
`void (No return value.)` **detach_graph_element_from_frame**(element: `StringName`)

Detaches the `element` `GraphElement` from the `GraphFrame` it is currently attached to.

`void (No return value.)` **disconnect_node**(from_node: `StringName`, from_port: `int`, to_node: `StringName`, to_port: `int`)
...
`void (No return value.)` **force_connection_drag_end**()
...
`void (No return value.)` **remove_valid_connection_type**(from_type: `int`, to_type: `int`)
...
`void (No return value.)` **remove_valid_left_disconnect_type**(type: `int`)
...
`void (No return value.)` **remove_valid_right_disconnect_type**(type: `int`)
...
`void (No return value.)` **set_connection_activity**(from_node: `StringName`, from_port: `int`, to_node: `StringName`, to_port: `int`, amount: `float`)
...
`void (No return value.)` **set_selected**(node: `Node`)
