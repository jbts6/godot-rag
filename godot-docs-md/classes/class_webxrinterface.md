...
- `void (No return value.)` **set_optional_features**(value: `String`)
...
- `void (No return value.)` **set_requested_reference_space_types**(value: `String`)
...
- `void (No return value.)` **set_required_features**(value: `String`)
...
- `void (No return value.)` **set_session_mode**(value: `String`)
...
`void (No return value.)` **is_session_supported**(session_mode: `String`)
...
`void (No return value.)` **set_display_refresh_rate**(refresh_rate: `float`)
