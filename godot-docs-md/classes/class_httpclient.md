...
- `void (No return value.)` **set_blocking_mode**(value: `bool`)
...
- `void (No return value.)` **set_connection**(value: `StreamPeer`)
...
- `void (No return value.)` **set_read_chunk_size**(value: `int`)
