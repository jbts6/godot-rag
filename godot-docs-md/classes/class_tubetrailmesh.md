...
- `void (No return value.)` **set_cap_bottom**(value: `bool`)
- `bool` **is_cap_bottom**()
...
- `void (No return value.)` **set_cap_top**(value: `bool`)
- `bool` **is_cap_top**()
...
- `void (No return value.)` **set_radial_steps**(value: `int`)
...
- `void (No return value.)` **set_section_length**(value: `float`)
...
- `void (No return value.)` **set_section_rings**(value: `int`)
...
- `void (No return value.)` **set_sections**(value: `int`)
- `int` **get_sections**()
