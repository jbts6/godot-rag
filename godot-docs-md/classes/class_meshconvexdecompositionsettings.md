...
- `void (No return value.)` **set_convex_hull_approximation**(value: `bool`)
...
- `void (No return value.)` **set_convex_hull_downsampling**(value: `int`)
...
- `void (No return value.)` **set_max_concavity**(value: `float`)
...
- `void (No return value.)` **set_max_convex_hulls**(value: `int`)
...
- `void (No return value.)` **set_max_num_vertices_per_convex_hull**(value: `int`)
...
- `void (No return value.)` **set_min_volume_per_convex_hull**(value: `float`)
...
- `void (No return value.)` **set_normalize_mesh**(value: `bool`)
...
- `void (No return value.)` **set_plane_downsampling**(value: `int`)
...
- `void (No return value.)` **set_project_hull_vertices**(value: `bool`)
...
- `void (No return value.)` **set_resolution**(value: `int`)
- `int` **get_resolution**()
...
- `void (No return value.)` **set_revolution_axes_clipping_bias**(value: `float`)
...
- `void (No return value.)` **set_symmetry_planes_clipping_bias**(value: `float`)
