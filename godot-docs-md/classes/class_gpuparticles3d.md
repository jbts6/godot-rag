...
- `void (No return value.)` **set_amount_ratio**(value: `float`)
...
- `void (No return value.)` **set_collision_base_size**(value: `float`)
...
- `void (No return value.)` **set_draw_pass_mesh**(pass: `int`, mesh: `Mesh`)
...
- `void (No return value.)` **set_draw_passes**(value: `int`)
- `int` **get_draw_passes**()
...
- `void (No return value.)` **set_skin**(value: `Skin`)
- `Skin` **get_skin**()
...
- `void (No return value.)` **set_interp_to_end**(value: `float`)
...
- `void (No return value.)` **set_interpolate**(value: `bool`)
...
- `void (No return value.)` **set_process_material**(value: `Material`)
...
- `void (No return value.)` **set_sub_emitter**(value: `NodePath`)
...
- `void (No return value.)` **set_trail_enabled**(value: `bool`)
...
- `void (No return value.)` **set_trail_lifetime**(value: `float`)
...
- `void (No return value.)` **set_transform_align**(value: `TransformAlign`)
...
- `void (No return value.)` **set_transform_align_axis**(value: `ParticlesTransformAlignAxis`)
...
- `void (No return value.)` **set_transform_align_channel_filter**(value: `ParticlesTransformAlignCustomSrc`)
...
`void (No return value.)` **emit_particle**(xform: `Transform3D`, velocity: `Vector3`, color: `Color`, custom: `Color`, flags: `int`)
