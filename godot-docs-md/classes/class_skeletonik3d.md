...
- `void (No return value.)` **set_interpolation**(value: `float`)
...
- `void (No return value.)` **set_magnet_position**(value: `Vector3`)
...
- `void (No return value.)` **set_override_tip_basis**(value: `bool`)
...
- `void (No return value.)` **set_target_transform**(value: `Transform3D`)
...
- `void (No return value.)` **set_tip_bone**(value: `StringName`)
...
- `void (No return value.)` **set_use_magnet**(value: `bool`)
...
`void (No return value.)` **start**(one_time: `bool` = false)
