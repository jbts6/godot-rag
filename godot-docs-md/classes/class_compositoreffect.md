...
- `void (No return value.)` **set_access_resolved_color**(value: `bool`)
...
- `void (No return value.)` **set_access_resolved_depth**(value: `bool`)
...
- `void (No return value.)` **set_effect_callback_type**(value: `EffectCallbackType`)
...
- `void (No return value.)` **set_needs_motion_vectors**(value: `bool`)
...
- `void (No return value.)` **set_needs_normal_roughness**(value: `bool`)
...
- `void (No return value.)` **set_needs_separate_specular**(value: `bool`)
...
`void (No return value.)` **\_render_callback**(effect_callback_type: `int`, render_data: `RenderData`) `virtual (This method should typically be overridden by the user to have any effect.)`
