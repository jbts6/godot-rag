...
- `void (No return value.)` **set_cubic_interpolation**(value: `bool`)
...
- `void (No return value.)` **set_progress**(value: `float`)
- `float` **get_progress**()
...
- `void (No return value.)` **set_progress_ratio**(value: `float`)
...
- `void (No return value.)` **set_rotation_mode**(value: `RotationMode`)
...
- `void (No return value.)` **set_tilt_enabled**(value: `bool`)
...
- `void (No return value.)` **set_use_model_front**(value: `bool`)
...
`Transform3D` **correct_posture**(transform: `Transform3D`, rotation_mode: `RotationMode`) `static (This method doesn't need an instance to be called, so it can be called directly using the class name.)`
