...
- `void (No return value.)` **set_autowrap**(value: `bool`)
- `bool` **has_autowrap**()
...
- `void (No return value.)` **set_close_on_escape**(value: `bool`)
...
- `void (No return value.)` **set_hide_on_ok**(value: `bool`)
- `bool` **get_hide_on_ok**()
...
- `void (No return value.)` **set_ok_button_text**(value: `String`)
...
`void (No return value.)` **register_text_enter**(line_edit: `LineEdit`)

Registers a `LineEdit` in the dialog. When the enter key is pressed, the dialog will be accepted.

`void (No return value.)` **remove_button**(button: `Button`)
