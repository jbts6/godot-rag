...
- `void (No return value.)` **set_allow_object_decoding**(value: `bool`)
...
- `void (No return value.)` **set_auth_callback**(value: `Callable`)
...
- `void (No return value.)` **set_auth_timeout**(value: `float`)
...
- `void (No return value.)` **set_max_delta_packet_size**(value: `int`)
...
- `void (No return value.)` **set_max_sync_packet_size**(value: `int`)
...
- `void (No return value.)` **set_refuse_new_connections**(value: `bool`)
...
- `void (No return value.)` **set_server_relay_enabled**(value: `bool`)
...
`void (No return value.)` **disconnect_peer**(id: `int`)
