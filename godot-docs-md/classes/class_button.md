...
- `void (No return value.)` **set_text_alignment**(value: `HorizontalAlignment`)
...
`BitField (This value is an integer composed as a bitmask of the following flags.)`\[`LineBreakFlag`\] **autowrap_trim_flags** = `128`
...
- `void (No return value.)` **set_expand_icon**(value: `bool`)
- `bool` **is_expand_icon**()
...
- `void (No return value.)` **set_button_icon**(value: `Texture2D`)
...
- `void (No return value.)` **set_icon_alignment**(value: `HorizontalAlignment`)
...
- `void (No return value.)` **set_vertical_icon_alignment**(value: `VerticalAlignment`)
