...
- `void (No return value.)` **set_action_sets**(value: `Array`)
...
- `void (No return value.)` **set_interaction_profiles**(value: `Array`)
...
`void (No return value.)` **add_action_set**(action_set: `OpenXRActionSet`)

Add an action set.

`void (No return value.)` **add_interaction_profile**(interaction_profile: `OpenXRInteractionProfile`)

Add an interaction profile.

`void (No return value.)` **create_default_action_sets**()
...
`void (No return value.)` **remove_action_set**(action_set: `OpenXRActionSet`)

Remove an action set.

`void (No return value.)` **remove_interaction_profile**(interaction_profile: `OpenXRInteractionProfile`)
