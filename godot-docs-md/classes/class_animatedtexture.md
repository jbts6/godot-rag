...
- `void (No return value.)` **set_current_frame**(value: `int`)
...
- `void (No return value.)` **set_frames**(value: `int`)
- `int` **get_frames**()
...
`void (No return value.)` **set_frame_duration**(frame: `int`, duration: `float`)
...
`void (No return value.)` **set_frame_texture**(frame: `int`, texture: `Texture2D`)
