...
- `void (No return value.)` **set_transfer_channel**(value: `int`)
...
- `void (No return value.)` **set_transfer_mode**(value: `TransferMode`)
...
`void (No return value.)` **disconnect_peer**(peer: `int`, force: `bool` = false)
...
`void (No return value.)` **set_target_peer**(id: `int`)
