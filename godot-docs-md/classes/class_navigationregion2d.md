...
- `void (No return value.)` **set_navigation_polygon**(value: `NavigationPolygon`)
...
- `void (No return value.)` **set_use_edge_connections**(value: `bool`)
...
`void (No return value.)` **bake_navigation_polygon**(on_thread: `bool` = true)
