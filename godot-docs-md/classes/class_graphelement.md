...
- `void (No return value.)` **set_draggable**(value: `bool`)
- `bool` **is_draggable**()
...
- `void (No return value.)` **set_position_offset**(value: `Vector2`)
...
- `void (No return value.)` **set_resizable**(value: `bool`)
- `bool` **is_resizable**()
...
- `void (No return value.)` **set_scaling_menus**(value: `bool`)
...
- `void (No return value.)` **set_selected**(value: `bool`)
- `bool` **is_selected**()
