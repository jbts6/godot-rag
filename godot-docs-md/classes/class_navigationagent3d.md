...
- `void (No return value.)` **set_avoidance_enabled**(value: `bool`)
...
- `void (No return value.)` **set_avoidance_layers**(value: `int`)
...
- `void (No return value.)` **set_avoidance_mask**(value: `int`)
...
- `void (No return value.)` **set_avoidance_priority**(value: `float`)
...
- `void (No return value.)` **set_debug_enabled**(value: `bool`)
...
- `void (No return value.)` **set_debug_path_custom_color**(value: `Color`)
...
- `void (No return value.)` **set_debug_path_custom_point_size**(value: `float`)
...
- `void (No return value.)` **set_debug_use_custom**(value: `bool`)
...
- `void (No return value.)` **set_keep_y_velocity**(value: `bool`)
...
- `void (No return value.)` **set_max_neighbors**(value: `int`)
...
- `void (No return value.)` **set_max_speed**(value: `float`)
- `float` **get_max_speed**()
...
- `void (No return value.)` **set_neighbor_distance**(value: `float`)
...
- `void (No return value.)` **set_path_desired_distance**(value: `float`)
...
- `void (No return value.)` **set_path_height_offset**(value: `float`)
...
- `void (No return value.)` **set_path_max_distance**(value: `float`)
- `float` **get_path_max_distance**()

The maximum distance the agent is allowed away from the ideal path to the final position. This can happen due to trying to avoid collisions. When the maximum distance is exceeded, it recalculates the ideal path.

`BitField (This value is an integer composed as a bitmask of the following flags.)`\[`PathMetadataFlags`\] **path_metadata_flags** = `7`

- `void (No return value.)` **set_path_metadata_flags**(value: `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`PathMetadataFlags`\])
- `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`PathMetadataFlags`\] **get_path_metadata_flags**()
...
- `void (No return value.)` **set_target_desired_distance**(value: `float`)
...
- `void (No return value.)` **set_time_horizon_agents**(value: `float`)
...
- `void (No return value.)` **set_time_horizon_obstacles**(value: `float`)
...
- `void (No return value.)` **set_use_3d_avoidance**(value: `bool`)
...
- `void (No return value.)` **set_velocity**(value: `Vector3`)
...
`void (No return value.)` **set_avoidance_layer_value**(layer_number: `int`, value: `bool`)
...
`void (No return value.)` **set_avoidance_mask_value**(mask_number: `int`, value: `bool`)

Based on `value`, enables or disables the specified mask in the `avoidance_mask` bitmask, given a `mask_number` between 1 and 32.

`void (No return value.)` **set_navigation_layer_value**(layer_number: `int`, value: `bool`)
...
`void (No return value.)` **set_velocity_forced**(velocity: `Vector3`)
