...
- `void (No return value.)` **set_cast_shadows_setting**(value: `ShadowCastingSetting`)
...
- `void (No return value.)` **set_custom_aabb**(value: `AABB`)
...
- `void (No return value.)` **set_extra_cull_margin**(value: `float`)
...
- `void (No return value.)` **set_lightmap_scale**(value: `LightmapScale`)
...
- `void (No return value.)` **set_lightmap_texel_scale**(value: `float`)
...
- `void (No return value.)` **set_gi_mode**(value: `GIMode`)
- `GIMode` **get_gi_mode**()
...
- `void (No return value.)` **set_ignore_occlusion_culling**(value: `bool`)
...
- `void (No return value.)` **set_lod_bias**(value: `float`)
- `float` **get_lod_bias**()
...
- `void (No return value.)` **set_material_overlay**(value: `Material`)
...
- `void (No return value.)` **set_material_override**(value: `Material`)
...
- `void (No return value.)` **set_transparency**(value: `float`)
...
- `void (No return value.)` **set_visibility_range_begin**(value: `float`)
...
- `void (No return value.)` **set_visibility_range_begin_margin**(value: `float`)
...
- `void (No return value.)` **set_visibility_range_end**(value: `float`)
...
- `void (No return value.)` **set_visibility_range_end_margin**(value: `float`)
...
- `void (No return value.)` **set_visibility_range_fade_mode**(value: `VisibilityRangeFadeMode`)
