...
- `void (No return value.)` **set_auto_exposure_max_exposure_value**(value: `float`)
...
- `void (No return value.)` **set_auto_exposure_min_exposure_value**(value: `float`)
...
- `void (No return value.)` **set_aperture**(value: `float`)
- `float` **get_aperture**()
...
- `void (No return value.)` **set_shutter_speed**(value: `float`)
...
- `void (No return value.)` **set_focal_length**(value: `float`)
...
- `void (No return value.)` **set_focus_distance**(value: `float`)
