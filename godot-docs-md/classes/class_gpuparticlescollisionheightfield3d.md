...
- `void (No return value.)` **set_follow_camera_enabled**(value: `bool`)
...
- `void (No return value.)` **set_heightfield_mask**(value: `int`)
...
- `void (No return value.)` **set_resolution**(value: `Resolution`)
...
`void (No return value.)` **set_heightfield_mask_value**(layer_number: `int`, value: `bool`)
