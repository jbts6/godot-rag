...
- `void (No return value.)` **set_alpha_curve**(value: `Texture2D`)
...
- `void (No return value.)` **set_param_texture**(param: `Parameter`, texture: `Texture2D`)
...
- `void (No return value.)` **set_attractor_interaction_enabled**(value: `bool`)
...
- `void (No return value.)` **set_collision_bounce**(value: `float`)
...
- `void (No return value.)` **set_collision_friction**(value: `float`)
...
- `void (No return value.)` **set_collision_mode**(value: `CollisionMode`)
...
- `void (No return value.)` **set_collision_use_scale**(value: `bool`)
...
- `void (No return value.)` **set_color_initial_ramp**(value: `Texture2D`)
...
- `void (No return value.)` **set_color_ramp**(value: `Texture2D`)
...
- `void (No return value.)` **set_emission_color_texture**(value: `Texture2D`)
...
- `void (No return value.)` **set_emission_curve**(value: `Texture2D`)
...
- `void (No return value.)` **set_emission_normal_texture**(value: `Texture2D`)
...
- `void (No return value.)` **set_emission_point_count**(value: `int`)
...
- `void (No return value.)` **set_emission_point_texture**(value: `Texture2D`)
...
- `void (No return value.)` **set_emission_shape_offset**(value: `Vector3`)
...
- `void (No return value.)` **set_emission_shape_scale**(value: `Vector3`)
...
- `void (No return value.)` **set_inherit_velocity_ratio**(value: `float`)
...
- `void (No return value.)` **set_rotation_3d_max**(value: `Vector3`)
...
- `void (No return value.)` **set_rotation_3d_min**(value: `Vector3`)
...
- `void (No return value.)` **set_rotation_velocity_3d_curve**(value: `Texture2D`)
...
- `void (No return value.)` **set_rotation_velocity_3d_max**(value: `Vector3`)
...
- `void (No return value.)` **set_rotation_velocity_3d_min**(value: `Vector3`)
...
- `void (No return value.)` **set_scale_3d_max**(value: `Vector3`)
...
- `void (No return value.)` **set_scale_3d_min**(value: `Vector3`)
...
- `void (No return value.)` **set_sub_emitter_amount_at_collision**(value: `int`)
...
- `void (No return value.)` **set_sub_emitter_amount_at_end**(value: `int`)
...
- `void (No return value.)` **set_sub_emitter_amount_at_start**(value: `int`)
...
- `void (No return value.)` **set_sub_emitter_frequency**(value: `float`)
...
- `void (No return value.)` **set_sub_emitter_keep_velocity**(value: `bool`)
...
- `void (No return value.)` **set_sub_emitter_mode**(value: `SubEmitterMode`)
...
- `void (No return value.)` **set_turbulence_enabled**(value: `bool`)
...
- `void (No return value.)` **set_turbulence_noise_scale**(value: `float`)
...
- `void (No return value.)` **set_turbulence_noise_speed**(value: `Vector3`)
...
- `void (No return value.)` **set_turbulence_noise_speed_random**(value: `float`)
...
- `void (No return value.)` **set_turbulence_noise_strength**(value: `float`)
...
- `void (No return value.)` **set_use_rotation_3d**(value: `bool`)
...
- `void (No return value.)` **set_using_rotation_velocity_3d**(value: `bool`)
...
- `void (No return value.)` **set_use_scale_3d**(value: `bool`)
...
- `void (No return value.)` **set_velocity_limit_curve**(value: `Texture2D`)
...
- `void (No return value.)` **set_velocity_pivot**(value: `Vector3`)
...
`void (No return value.)` **set_param**(param: `Parameter`, value: `Vector2`)
