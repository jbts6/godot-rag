...
- `void (No return value.)` **set_cellular_distance_function**(value: `CellularDistanceFunction`)
...
- `void (No return value.)` **set_cellular_jitter**(value: `float`)
...
- `void (No return value.)` **set_cellular_return_type**(value: `CellularReturnType`)
...
- `void (No return value.)` **set_domain_warp_amplitude**(value: `float`)
...
- `void (No return value.)` **set_domain_warp_enabled**(value: `bool`)
...
- `void (No return value.)` **set_domain_warp_fractal_gain**(value: `float`)
...
- `void (No return value.)` **set_domain_warp_fractal_lacunarity**(value: `float`)
...
- `void (No return value.)` **set_domain_warp_fractal_octaves**(value: `int`)
...
- `void (No return value.)` **set_domain_warp_fractal_type**(value: `DomainWarpFractalType`)
...
- `void (No return value.)` **set_domain_warp_frequency**(value: `float`)
...
- `void (No return value.)` **set_domain_warp_type**(value: `DomainWarpType`)
...
- `void (No return value.)` **set_fractal_gain**(value: `float`)
...
- `void (No return value.)` **set_fractal_lacunarity**(value: `float`)
...
- `void (No return value.)` **set_fractal_octaves**(value: `int`)
...
- `void (No return value.)` **set_fractal_ping_pong_strength**(value: `float`)
...
- `void (No return value.)` **set_fractal_type**(value: `FractalType`)
...
- `void (No return value.)` **set_fractal_weighted_strength**(value: `float`)
...
- `void (No return value.)` **set_noise_type**(value: `NoiseType`)
...
- `void (No return value.)` **set_offset**(value: `Vector3`)
- `Vector3` **get_offset**()
