...
- `void (No return value.)` **set_use_bbcode**(value: `bool`)
...
- `void (No return value.)` **set_effects**(value: `Array`)
- `Array` **get_effects**()
...
- `void (No return value.)` **set_fit_content**(value: `bool`)
...
- `void (No return value.)` **set_hint_underline**(value: `bool`)
...
- `void (No return value.)` **set_meta_underline**(value: `bool`)
...
- `void (No return value.)` **set_progress_bar_delay**(value: `int`)
...
- `void (No return value.)` **set_scroll_active**(value: `bool`)
...
- `void (No return value.)` **set_scroll_follow**(value: `bool`)
...
- `void (No return value.)` **set_scroll_follow_visible_characters**(value: `bool`)
...
- `void (No return value.)` **set_selection_enabled**(value: `bool`)
...
- `void (No return value.)` **set_tab_size**(value: `int`)
- `int` **get_tab_size**()
...
- `void (No return value.)` **set_threaded**(value: `bool`)
- `bool` **is_threaded**()
...
`void (No return value.)` **add_hr**(width: `int` = 90, height: `int` = 2, color: `Color` = Color(1, 1, 1, 1), alignment: `HorizontalAlignment` = 1, width_in_percent: `bool` = true, height_in_percent: `bool` = false)
...
`void (No return value.)` **add_image**(image: `Texture2D`, width: `float` = 0, height: `float` = 0, color: `Color` = Color(1, 1, 1, 1), inline_align: `InlineAlignment` = 5, region: `Rect2` = Rect2(0, 0, 0, 0), key: `Variant` = null, pad: `bool` = false, tooltip: `String` = "", width_unit: `ImageUnit` = 0, height_unit: `ImageUnit` = 0, alt_text: `String` = "")
...
`void (No return value.)` **add_text**(text: `String`)

Adds raw non-BBCode-parsed text to the tag stack.

`void (No return value.)` **append_text**(bbcode: `String`)
...
`void (No return value.)` **install_effect**(effect: `Variant`)
...
`void (No return value.)` **parse_bbcode**(bbcode: `String`)
...
`void (No return value.)` **pop**()

Terminates the current tag. Use after `push_*` methods to close BBCodes manually. Does not need to follow `add_*` methods.

`void (No return value.)` **pop_all**()

Terminates all tags opened by `push_*` methods.

`void (No return value.)` **pop_context**()
...
`void (No return value.)` **push_bgcolor**(bgcolor: `Color`)
...
`void (No return value.)` **push_color**(color: `Color`)

Adds a `[color]` tag to the tag stack.

`void (No return value.)` **push_context**()

Adds a context marker to the tag stack. See `pop_context()`.

`void (No return value.)` **push_customfx**(effect: `RichTextEffect`, env: `Dictionary`)
...
`void (No return value.)` **push_dropcap**(string: `String`, font: `Font`, size: `int`, dropcap_margins: `Rect2` = Rect2(0, 0, 0, 0), color: `Color` = Color(1, 1, 1, 1), outline_size: `int` = 0, outline_color: `Color` = Color(0, 0, 0, 0))
...
`void (No return value.)` **push_fgcolor**(fgcolor: `Color`)
...
`void (No return value.)` **push_mono**()

Adds a `[font]` tag with a monospace font to the tag stack.

`void (No return value.)` **push_normal**()

Adds a `[font]` tag with a normal font to the tag stack.

`void (No return value.)` **push_outline_color**(color: `Color`)

Adds a `[outline_color]` tag to the tag stack. Adds text outline for its duration.

`void (No return value.)` **push_outline_size**(outline_size: `int`)

Adds a `[outline_size]` tag to the tag stack. Overrides default text outline size for its duration.

`void (No return value.)` **push_paragraph**(alignment: `HorizontalAlignment`, base_direction: `TextDirection` = 0, language: `String` = "", st_parser: `StructuredTextParser` = 0, justification_flags: `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`JustificationFlag`\] = 163, tab_stops: `PackedFloat32Array` = PackedFloat32Array())

Adds a `[p]` tag to the tag stack.

`void (No return value.)` **push_strikethrough**(color: `Color` = Color(0, 0, 0, 0))
...
`void (No return value.)` **push_table**(columns: `int`, inline_align: `InlineAlignment` = 0, align_to_row: `int` = -1, name: `String` = "")
...
`void (No return value.)` **push_underline**(color: `Color` = Color(0, 0, 0, 0))
...
`void (No return value.)` **reload_effects**()
...
`void (No return value.)` **scroll_to_line**(line: `int`)

Scrolls the window's top line to match `line`.

`void (No return value.)` **scroll_to_paragraph**(paragraph: `int`)

Scrolls the window's top line to match first line of the `paragraph`.

`void (No return value.)` **scroll_to_selection**()
...
`void (No return value.)` **set_cell_border_color**(color: `Color`)

Sets color of a table cell border.

`void (No return value.)` **set_cell_padding**(padding: `Rect2`)

Sets inner padding of a table cell.

`void (No return value.)` **set_cell_row_background_color**(odd_row_bg: `Color`, even_row_bg: `Color`)

Sets color of a table cell. Separate colors for alternating rows can be specified.

`void (No return value.)` **set_cell_size_override**(min_size: `Vector2`, max_size: `Vector2`)

Sets minimum and maximum size overrides for a table cell.

`void (No return value.)` **set_table_column_expand**(column: `int`, expand: `bool`, ratio: `int` = 1, shrink: `bool` = true)
...
`void (No return value.)` **set_table_column_name**(column: `int`, name: `String`)

Sets table column name for assistive apps.

`void (No return value.)` **update_image**(key: `Variant`, mask: `BitField (This value is an integer composed as a bitmask of the following flags.)`\[`ImageUpdateMask`\], image: `Texture2D`, width: `float` = 0, height: `float` = 0, color: `Color` = Color(1, 1, 1, 1), inline_align: `InlineAlignment` = 5, region: `Rect2` = Rect2(0, 0, 0, 0), pad: `bool` = false, tooltip: `String` = "", width_unit: `ImageUnit` = 0, height_unit: `ImageUnit` = 0)
