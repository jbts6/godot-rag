...
- `void (No return value.)` **set_albedo**(value: `Color`)
- `Color` **get_albedo**()
...
- `void (No return value.)` **set_texture**(param: `TextureParam`, texture: `Texture2D`)
...
- `void (No return value.)` **set_flag**(flag: `Flags`, enable: `bool`)
...
- `void (No return value.)` **set_alpha_antialiasing_edge**(value: `float`)
...
- `void (No return value.)` **set_alpha_antialiasing**(value: `AlphaAntiAliasing`)
...
- `void (No return value.)` **set_alpha_hash_scale**(value: `float`)
...
- `void (No return value.)` **set_alpha_scissor_threshold**(value: `float`)
...
- `void (No return value.)` **set_anisotropy**(value: `float`)
...
- `void (No return value.)` **set_feature**(feature: `Feature`, enable: `bool`)
...
- `void (No return value.)` **set_ao_light_affect**(value: `float`)
...
- `void (No return value.)` **set_ao_texture_channel**(value: `TextureChannel`)
...
- `void (No return value.)` **set_backlight**(value: `Color`)
- `Color` **get_backlight**()
...
- `void (No return value.)` **set_billboard_mode**(value: `BillboardMode`)
...
- `void (No return value.)` **set_clearcoat**(value: `float`)
- `float` **get_clearcoat**()
...
- `void (No return value.)` **set_clearcoat_roughness**(value: `float`)
...
- `void (No return value.)` **set_depth_draw_mode**(value: `DepthDrawMode`)
...
- `void (No return value.)` **set_depth_test**(value: `DepthTest`)
...
- `void (No return value.)` **set_detail_blend_mode**(value: `BlendMode`)
...
- `void (No return value.)` **set_detail_uv**(value: `DetailUV`)
...
- `void (No return value.)` **set_diffuse_mode**(value: `DiffuseMode`)
...
- `void (No return value.)` **set_distance_fade_max_distance**(value: `float`)
...
- `void (No return value.)` **set_distance_fade_min_distance**(value: `float`)
...
- `void (No return value.)` **set_distance_fade**(value: `DistanceFadeMode`)
...
- `void (No return value.)` **set_emission**(value: `Color`)
- `Color` **get_emission**()
...
- `void (No return value.)` **set_emission_energy_multiplier**(value: `float`)
...
- `void (No return value.)` **set_emission_intensity**(value: `float`)
...
- `void (No return value.)` **set_emission_operator**(value: `EmissionOperator`)
...
- `void (No return value.)` **set_fov_override**(value: `float`)
...
- `void (No return value.)` **set_grow_enabled**(value: `bool`)
...
- `void (No return value.)` **set_grow**(value: `float`)
- `float` **get_grow**()
...
- `void (No return value.)` **set_heightmap_deep_parallax**(value: `bool`)
...
- `void (No return value.)` **set_heightmap_deep_parallax_flip_binormal**(value: `bool`)
...
- `void (No return value.)` **set_heightmap_deep_parallax_flip_tangent**(value: `bool`)
...
- `void (No return value.)` **set_heightmap_deep_parallax_max_layers**(value: `int`)
...
- `void (No return value.)` **set_heightmap_deep_parallax_min_layers**(value: `int`)
...
- `void (No return value.)` **set_heightmap_scale**(value: `float`)
...
- `void (No return value.)` **set_metallic**(value: `float`)
- `float` **get_metallic**()
...
- `void (No return value.)` **set_specular**(value: `float`)
- `float` **get_specular**()
...
- `void (No return value.)` **set_metallic_texture_channel**(value: `TextureChannel`)
...
- `void (No return value.)` **set_msdf_outline_size**(value: `float`)
...
- `void (No return value.)` **set_msdf_pixel_range**(value: `float`)
...
- `void (No return value.)` **set_normal_scale**(value: `float`)
...
- `void (No return value.)` **set_particles_anim_h_frames**(value: `int`)
...
- `void (No return value.)` **set_particles_anim_loop**(value: `bool`)
...
- `void (No return value.)` **set_particles_anim_v_frames**(value: `int`)
...
- `void (No return value.)` **set_point_size**(value: `float`)
...
- `void (No return value.)` **set_proximity_fade_distance**(value: `float`)
...
- `void (No return value.)` **set_proximity_fade_enabled**(value: `bool`)
...
- `void (No return value.)` **set_refraction**(value: `float`)
...
- `void (No return value.)` **set_refraction_texture_channel**(value: `TextureChannel`)
...
- `void (No return value.)` **set_rim**(value: `float`)
- `float` **get_rim**()
...
- `void (No return value.)` **set_rim_tint**(value: `float`)
- `float` **get_rim_tint**()
...
- `void (No return value.)` **set_roughness**(value: `float`)
- `float` **get_roughness**()
...
- `void (No return value.)` **set_roughness_texture_channel**(value: `TextureChannel`)
...
- `void (No return value.)` **set_shading_mode**(value: `ShadingMode`)
...
- `void (No return value.)` **set_specular_mode**(value: `SpecularMode`)
...
- `void (No return value.)` **set_stencil_effect_color**(value: `Color`)
...
- `void (No return value.)` **set_stencil_compare**(value: `StencilCompare`)
...
- `void (No return value.)` **set_stencil_flags**(value: `int`)
...
- `void (No return value.)` **set_stencil_mode**(value: `StencilMode`)
...
- `void (No return value.)` **set_stencil_effect_outline_thickness**(value: `float`)
...
- `void (No return value.)` **set_stencil_reference**(value: `int`)
...
- `void (No return value.)` **set_subsurface_scattering_strength**(value: `float`)
...
- `void (No return value.)` **set_transmittance_boost**(value: `float`)
...
- `void (No return value.)` **set_transmittance_color**(value: `Color`)
...
- `void (No return value.)` **set_transmittance_depth**(value: `float`)
...
- `void (No return value.)` **set_transparency**(value: `Transparency`)
...
- `void (No return value.)` **set_uv1_offset**(value: `Vector3`)
...
- `void (No return value.)` **set_uv1_scale**(value: `Vector3`)
...
- `void (No return value.)` **set_uv1_triplanar_blend_sharpness**(value: `float`)
...
- `void (No return value.)` **set_uv2_offset**(value: `Vector3`)
...
- `void (No return value.)` **set_uv2_scale**(value: `Vector3`)
...
- `void (No return value.)` **set_uv2_triplanar_blend_sharpness**(value: `float`)
...
- `void (No return value.)` **set_z_clip_scale**(value: `float`)
