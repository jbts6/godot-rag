...
`void (No return value.)` **\_begin_handle_action**(gizmo: `EditorNode3DGizmo`, handle_id: `int`, secondary: `bool`) `virtual (This method should typically be overridden by the user to have any effect.)`

There is currently no description for this method. Please help us by [contributing one](https://contributing.godotengine.org/en/latest/documentation/class_reference.html)!

`bool` **\_can_be_hidden**() `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`bool` **\_can_commit_handle_on_click**() `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`void (No return value.)` **\_commit_handle**(gizmo: `EditorNode3DGizmo`, handle_id: `int`, secondary: `bool`, restore: `Variant`, cancel: `bool`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`void (No return value.)` **\_commit_subgizmos**(gizmo: `EditorNode3DGizmo`, ids: `PackedInt32Array`, restores: `Array`\[`Transform3D`\], cancel: `bool`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`EditorNode3DGizmo` **\_create_gizmo**(for_node_3d: `Node3D`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`String` **\_get_gizmo_name**() `virtual (This method should typically be overridden by the user to have any effect.)` `const`

Override this method to provide the name that will appear in the gizmo visibility menu.

`String` **\_get_handle_name**(gizmo: `EditorNode3DGizmo`, handle_id: `int`, secondary: `bool`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`Variant` **\_get_handle_value**(gizmo: `EditorNode3DGizmo`, handle_id: `int`, secondary: `bool`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`int` **\_get_priority**() `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`Transform3D` **\_get_subgizmo_transform**(gizmo: `EditorNode3DGizmo`, subgizmo_id: `int`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`bool` **\_has_gizmo**(for_node_3d: `Node3D`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`bool` **\_is_handle_highlighted**(gizmo: `EditorNode3DGizmo`, handle_id: `int`, secondary: `bool`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`bool` **\_is_selectable_when_hidden**() `virtual (This method should typically be overridden by the user to have any effect.)` `const`

Override this method to define whether Node3D with this gizmo should be selectable even when the gizmo is hidden.

`void (No return value.)` **\_redraw**(gizmo: `EditorNode3DGizmo`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`void (No return value.)` **\_set_handle**(gizmo: `EditorNode3DGizmo`, handle_id: `int`, secondary: `bool`, camera: `Camera3D`, screen_pos: `Vector2`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`void (No return value.)` **\_set_subgizmo_transform**(gizmo: `EditorNode3DGizmo`, subgizmo_id: `int`, transform: `Transform3D`) `virtual (This method should typically be overridden by the user to have any effect.)`
...
`PackedInt32Array` **\_subgizmos_intersect_frustum**(gizmo: `EditorNode3DGizmo`, camera: `Camera3D`, frustum_planes: `Array`\[`Plane`\]) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`int` **\_subgizmos_intersect_ray**(gizmo: `EditorNode3DGizmo`, camera: `Camera3D`, screen_pos: `Vector2`) `virtual (This method should typically be overridden by the user to have any effect.)` `const`
...
`void (No return value.)` **add_material**(name: `String`, material: `StandardMaterial3D`)
...
`void (No return value.)` **create_handle_material**(name: `String`, billboard: `bool` = false, texture: `Texture2D` = null)
...
`void (No return value.)` **create_icon_material**(name: `String`, texture: `Texture2D`, on_top: `bool` = false, color: `Color` = Color(1, 1, 1, 1))
...
`void (No return value.)` **create_material**(name: `String`, color: `Color`, billboard: `bool` = false, on_top: `bool` = false, use_vertex_color: `bool` = false)
