...
- `void (No return value.)` **set_max_steps**(value: `int`)
- `int` **get_max_steps**()
...
`void (No return value.)` **add_do_method**(callable: `Callable`)

Register a `Callable` that will be called when the action is committed.

`void (No return value.)` **add_do_property**(object: `Object`, property: `StringName`, value: `Variant`)

Register a `property` that would change its value to `value` when the action is committed.

`void (No return value.)` **add_do_reference**(object: `Object`)
...
`void (No return value.)` **add_undo_method**(callable: `Callable`)

Register a `Callable` that will be called when the action is undone.

`void (No return value.)` **add_undo_property**(object: `Object`, property: `StringName`, value: `Variant`)

Register a `property` that would change its value to `value` when the action is undone.

`void (No return value.)` **add_undo_reference**(object: `Object`)
...
`void (No return value.)` **create_action**(name: `String`, merge_mode: `MergeMode` = 0, backward_undo_ops: `bool` = false)
...
`void (No return value.)` **end_force_keep_in_merge_ends**()
...
`void (No return value.)` **start_force_keep_in_merge_ends**()
