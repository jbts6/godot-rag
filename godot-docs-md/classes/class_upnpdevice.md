...
- `void (No return value.)` **set_description_url**(value: `String`)
...
- `void (No return value.)` **set_igd_control_url**(value: `String`)
...
- `void (No return value.)` **set_igd_our_addr**(value: `String`)
...
- `void (No return value.)` **set_igd_service_type**(value: `String`)
...
- `void (No return value.)` **set_igd_status**(value: `IGDStatus`)
...
- `void (No return value.)` **set_service_type**(value: `String`)
